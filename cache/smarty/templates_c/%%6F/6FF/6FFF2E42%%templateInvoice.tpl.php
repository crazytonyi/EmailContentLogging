<?php /* Smarty version 2.6.11, created on 2021-03-04 16:21:50
...
<tbody>
<tr style="color: #ffffff;" bgcolor="#4B4B4B">
    <?php if ($this->_tpl_vars['withServices']): ?>
        <td width="60%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_QUANTITY']; ?>
</td>
        <td width="150%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_PART_NUMBER']; ?>
</td>
        <td width="150%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_PRODUCT']; ?>
</td>
        <td width="120%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_DURATION']; ?>
</td>
        <td width="80%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_LIST_PRICE']; ?>
</td>
        <td width="80%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_UNIT_PRICE']; ?>
</td>
        <td width="80%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_EXT_PRICE']; ?>
</td>
        <td width="80%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_DISCOUNT']; ?>
</td>
    <?php else: ?>
...
<tr>
    <?php if ($this->_tpl_vars['withServices']): ?>
        <td width="60%"><?php echo '{if isset($product.quantity)}{$product.quantity}{/if}'; ?>
</td>
        <td width="150%"><?php echo '{if isset($product.manufacturer_name)}{$product.manufacturer_name}{/if}
                {if isset($product.mft_part_num)}<br></br>{$product.mft_part_num}{/if}'; ?>
</td>
        <td width="150%"><?php echo '{if isset($product.name)}{$product.name}{/if}{if isset($product.list_price)}<br></br>{$product.description}{/if}'; ?>
</td>
        <td width="120%"><?php echo '
                ...
                {if !empty($product.service_start_date) && !empty($product.service_end_date)}
                        <br></br>';  echo $this->_tpl_vars['MOD']['LBL_TPL_DURATION_STARTS']; ?>
 <?php echo '{$product.service_start_date}
                        <br></br>';  echo $this->_tpl_vars['MOD']['LBL_TPL_DURATION_ENDS']; ?>
 <?php echo '{$product.service_end_date}
                {/if}'; ?>

        </td>
        <td align="right" width="80%"><?php echo '{if isset($product.list_price)}{$product.list_price}{/if}'; ?>
</td>
        <td align="right" width="80%"><?php echo '{if isset($product.discount_price)}{$product.discount_price}{/if}'; ?>
</td>
        <td align="right" width="80%"><?php echo '{if isset($product.ext_price)}{$product.ext_price}{/if}'; ?>
</td>
        <td align="right" width="80%"><?php echo '
    ...
    <?php else: ?>
        ...
        <td width="175%"><?php echo '{if isset($product.manufacturer_name)}{$product.manufacturer_name}{/if}
                {if isset($product.mft_part_num)}<br></br>{$product.mft_part_num}{/if}'; ?>
</td>
