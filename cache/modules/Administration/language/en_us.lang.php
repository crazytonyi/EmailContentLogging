...
',
  ...
  'LBL_LDAP_ENCRYPTION_TYPE_DESC' => 'Encryption type affects whether your connection to LDAP server will be secure or not. Use None for a regular non-secure connection. Use TLS to enforce your regular connection to be secure. Use SSL for a secure connection over ldaps://',
  'LBL_LDAP_SERVER_HOSTNAME_DESC' => 'Please specify only LDAP hostname of IP address. Example: ldap.example.com, 10.11.45.75',
...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_AWS_CONNECT_IDENTITY_HELP_TEXT' => 'Select how you wish to manage your users. Options include direct sign-on in Amazon Connect and single sign-on via SAML.',
