 ...
 */
SUGAR.FunctionMap = {
	'year'	:	SUGAR.expressions.YearExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'now'	:	SUGAR.expressions.NowExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'rollupConditionalMinDate'	:	SUGAR.expressions.MinDateConditionalRelatedExpression,	'dayofmonth'	:	SUGAR.expressions.DayOfMonthExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'log'	:	SUGAR.expressions.LogExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'prorateValue'	:	SUGAR.expressions.ProrateValueExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'strReplace'	:	SUGAR.expressions.StrReplaceExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'opportunitySalesStage'	:	SUGAR.expressions.OpportunitySalesStageExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
