...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s 一个 %s 记录，导致 SugarBPM<sup class="trademark">TM</sup> 触发 #%s 流程',
