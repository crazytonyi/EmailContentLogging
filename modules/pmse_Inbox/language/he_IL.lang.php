...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => 'רשומה %s a(n) %s, שגרמה ל-SugarBPM<sup class="trademark">TM</sup>‎ להפעיל תהליך #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'התהליך הושלם.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'התהליך הופסק.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'התהליך בוטל.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'התהליך נתקל בשגיאה.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'סטטוס של תהליך מספר %s',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'תהליך #{{id}}: סטטוס נוכחי',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'מציג יומני הרישום',
