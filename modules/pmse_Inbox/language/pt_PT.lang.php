...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s um registo de %s, fez com que o SugarBPM<sup class="trademark">TM</sup> ative um Processo #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'O processo foi concluído.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'O processo foi finalizado.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'O processo foi cancelado.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'O processo encontrou um erro.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Processo #%s: Estado Actual',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Processo #{{id}}: Estado Atual',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Visualizador de registos',
    ...
    'LBL_PMSE_CURRENT_ACTIVITY' => 'Actividade Actual',
);
