...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s tietue %s, joka aiheutti SugarBPM<sup class="trademark">TM</sup>:n käynnistämään prosessin #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Prosessi suoritettu.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Prosessi lopetettu.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Prosessi peruutettu.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Prosessi kohtasi virheen.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Process #%s: nykyinen status',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Prosessi #{{id}}: nykyinen tila',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Lokin katseluohjelma',
