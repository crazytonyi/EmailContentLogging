...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s 一個 %s 導致SugarBPM<sup class="trademark">TM</sup>觸發進程的記錄#%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => '流程已完成。',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => '流程已終止。',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => '流程已取消。',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => '流程中發生了一個錯誤。',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => '流程 #%s：目前狀態',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => '流程 #{{id}}：目前狀態',
    'LBL_PMSE_TITLE_LOG_VIEWER' => '記錄檢視器',
