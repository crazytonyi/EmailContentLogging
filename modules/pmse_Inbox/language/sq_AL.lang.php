...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s një regjistrim %s, i cili bëri që SugarBPM<sup class="trademark">TM</sup> të shkaktojë një proces #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Procesi u krye.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Procesi u ndërpre.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Procesi u anulua.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Procesi hasi një gabim.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Procesi #%s: Statusi aktual',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Procesi #{{id}}: Statusi aktual',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Paraqitësi i evidencës',
