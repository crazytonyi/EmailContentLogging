...
$mod_strings = array (
    ...
    'LBL_PMSE_INBOX_FOCUS_DRAWER_DASHBOARD' => 'Fioka fokusa za procese',
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s a(n) %s zapis, što je uzrokovalo da SugarBPM<sup class="trademark">TM</sup> pokrene proces #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Proces je završen.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Proces je prekinut.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Proces je otkazan.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Došlo je do greške u procesu.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Proces #%s: Trenutni status',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Proces #{{id}}: trenutni status',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Prikaz evidencije',
    ...
    'LBL_PMSE_CURRENT_ACTIVITY' => 'Trenutna aktivnost',
);
