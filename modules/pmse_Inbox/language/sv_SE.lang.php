...
$mod_strings = array (
    ...
    'LBL_PMSE_INBOX_FOCUS_DRAWER_DASHBOARD' => 'Fokuslåda för processer',
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s en %s post som orsakade SugarBPM<sup class="trademark">TM</sup> att trigga en process #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Processen fullföljdes.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Processen terminerades.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Processen avbröts.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Processen har stött på ett fel.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Process #%s: Nuvarande Status',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Process #{{id}}: Nuvarande Status',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Loggvisare',
    ...
    'LBL_PMSE_CURRENT_ACTIVITY' => 'Nuvarande aktivitet',
);
