...
$mod_strings = array (
    ...
    'LBL_PMSE_INBOX_FOCUS_DRAWER_DASHBOARD' => 'Panel de Enfoque de Procesos',
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s un registro %s, que hizo que SugarBPM<sup class="trademark">TM</sup> activara un proceso #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Se ha completado el proceso.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Se ha finalizado el proceso.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Se ha cancelado el proceso.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Se ha producido un error en el proceso.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Proceso #%s: Estado Actual',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Proceso #{{id}}: Estado Actual',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Visualizador de registros',
    ...
    'LBL_PROJECT_RUN_ORDER' => 'Ejecutar orden',
