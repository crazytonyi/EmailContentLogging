...
$mod_strings = array (
    ...
    'LBL_PMSE_INBOX_FOCUS_DRAWER_DASHBOARD' => 'Zásuvka zamerania na procesy',
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s %s záznam, ktorý spôsobil, že SugarBPM<sup class="trademark">TM</sup> spustil proces #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Proces bol dokončený.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Proces bol ukončený.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Proces bol zrušený.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'V procese došlo k chybe.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Process #%s: Current Status',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Proces #{{id}}: aktuálny stav',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Prehliadač denníkov',
    ...
    'LBL_PMSE_CURRENT_ACTIVITY' => 'Súčasná aktivita',
);
