...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_START_EVENT' => '%s %s запис, който е накарал SugarBPM<sup class="trademark">TM</sup> да задейства Процес #%s',
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Процесът е завършен.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Процесът е прекратен.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Процесът е отменен.',
    'LBL_PMSE_HISTORY_STATUS_ERROR' => 'Процесът се натъкна на грешка.',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR' => 'Процес #%s: Текущ статус',
    'LBL_PMSE_TITLE_IMAGE_GENERATOR_OBJ' => 'Процес #{{id}}: Текущ статус',
    'LBL_PMSE_TITLE_LOG_VIEWER' => 'Разглеждане на журнали',
