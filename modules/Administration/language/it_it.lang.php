...
$mod_strings = array (
    ...
    'ERR_UW_NO_PACKAGE'                         => 'Impossibile trovare il pacchetto mediante l&#39;ID.',
    'ERR_UW_NO_PACKAGE_FILE'                    => 'Impossibile trovare il file di pacchetto.',
    ...
    'ERR_UW_PACKAGE_EXISTS'                     => 'Il pacchetto esiste già.',
    ...
    'ERR_UW_REMOVE_INSTALLED_PACKAGE'           => "Si è verificato un problema durante la rimozione del pacchetto. Il pacchetto è ancora installato, disinstallarlo prima.",
    ...
    'ERR_UW_UNABLE_EXTRACT_FILE'                => "Impossibile estrarre il file. Errore ZIP: {0}. Stato: {1}",
    'ERR_UW_WRONG_PACKAGE_TYPE'                  => 'Questa azione può essere eseguita solo su {0}.',
    ...
    'LBL_LDAP_ENCRYPTION_TYPE'=> 'Crittografia:',
    ...
    'LBL_SUGAR_CLOUD_SETTINGS_TITLE' => 'Impostazioni SugarCloud',
    'LBL_SUGAR_CLOUD_SETTINGS_DESC' => 'Creare e gestire i record utente, gestire i requisiti delle password e impostare l&#39;autenticazione LDAP o SAML',
    ...
    'LBL_MANAGE_RELATE_DENORMALIZATION_TITLE' => 'Denormalizzazione campi relazione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_DESC' => 'Gestione della struttura del database',
    'LBL_MANAGE_RELATE_DENORMALIZATION_SAVE_WARNING' => 'La struttura del campo verrà aggiornata. Confermare?',
    'LBL_MANAGE_RELATE_DENORMALIZATION_MSG_EMPTY_REQUEST' => 'Richiesta vuota',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_SUPPORTED_TYPES' => 'È supportato solo il tipo: "relazione"',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_ALREADY_DENORMALIZED' => 'Il campo è stato già denormalizzato',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_PREV_JOB_IN_PROGRESS' => 'Impossibile eseguire la denormalizzazione mentre è in esecuzione il lavoro precedente',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_FIELD_IS_NOT_DENORMALIZED' => 'Campo non denormalizzato',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_LIST' => 'Elenco dei lavori di denormalizzazione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_DD_NOTE' => 'Trascinare il campo.',
    'LBL_MANAGE_RELATE_DENORMALIZATION_DENORMALIZATION' => 'Denormalizzazione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_NORMALIZATION' => 'Normalizzazione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_OK' => 'Ok',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_ERROR' => 'Errore',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_READY' => 'Pronto',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_NOT_POSSIBLE' => 'Non possibile',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_TABLES' => 'Tabelle con numero di righe',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_SQL_NOTE' => 'Per modificare la struttura del DB, è necessario eseguire il seguente SQL',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_ESTIMATED_TIME' => 'tempo stimato',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_ALTER_NOT_NECESSARY' => 'La struttura del DB è aggiornata.',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_FIELD' => 'campo',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PRECHECK_VARDEF_UPDATING' => 'Aggiornamento vardefs in corso',
    'LBL_MANAGE_RELATE_DENORMALIZATION_PROCESS_RUNNING' => 'In esecuzione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_COMMUNICATION_ERROR' => 'Errore di comunicazione',
    'LBL_MANAGE_RELATE_DENORMALIZATION_SYNC_COMPLETE' => 'Sincronizzazione completata',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_IS_NOT_SCHEDULED' => 'Lavoro non pianificato',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_DATA' => 'Dati lavoro',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_RESULT' => 'Risultato lavoro interno',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_STATUS' => 'Stato lavoro interno',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_EXECUTED' => 'Modificato/Eseguito',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_CREATED' => 'Creato',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_MESSAGE' => 'Messaggio lavoro',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_ROWS_PROCESSED' => 'Righe elaborate/totali',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_WAITING_FOR_JOB_STARTED' => 'in attesa di avvio lavoro',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_WAITING_FOR_ALTER' => 'Esecuzione MODIFICA TABELLA',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_TMP_TABLE_CREATING' => 'creazione di una tabella temporanea in corso',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_TMP_TABLE_PENDING' => 'tabella temporanea in sospeso',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_START_COPYING' => 'processo di copia in sospeso',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_COPYING' => 'copia in corso',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_FAIL' => 'errore',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_DONE' => 'eseguito',
    'LBL_MANAGE_RELATE_DENORMALIZATION_JOB_WORK_STATUS' => 'Stato lavoro',
...
//END SUGARCRM flav=een
    ...
    'LBL_DBARCHIVER_TITLE' => 'Archivia record',
    'LBL_DBARCHIVER' => 'Archivia i dati dalle tabelle attive nel sistema',
...
",
    ...
    'WARN_LICENSE_SEATS_USER_CREATE'=>"<b>Avviso:</b> Non sarà possibile creare ulteriori utenti attivi."
        . " Acquistare altre sottoscrizioni.",
    'WARN_REPAIR_CONFIG' => '<b>Avvertenza:</b> Il file config.php deve essere riparato.  Utilizzare lo script <a href=&#39;index.php?module=Administration&action=RebuildConfig&#39;>Ricostruisci file di configurazione</a> nella pagina di riparazione nell&#39;area Amministrazione per riparare il file di configurazione.',
...
'ML_NO_PACKAGE_NAME'=>'Il manifesto deve contenere il nome(installdefs[id] o [name] manifesto)',
'ML_NO_PACKAGE_VERSION'=>'Il manifesto deve contenere la versione([version] manifesto)',
...
'ML_LANGUAGE_FILE_KEYS_INVALID'=>'Chiave - può essere composta esclusivamente da lettere, numeri e tratti bassi. ',
    ...
    'LBL_GLOBAL_SEARCH_SETTINGS_TITLE' => 'La ricerca a testo completo verrà utilizzata per restituire risultati per una ricerca globale nell&#39;applicazione desktop. Affinché i risultati vengano restituiti per un particolare modulo, deve essere abilitato di seguito. Assicurarsi di eseguire un indice di sistema completo dopo aver abilitato i moduli per la ricerca di testo completo. I singoli campi del modulo possono essere abilitati per la ricerca di testo completo tramite <a href="index.php?module=ModuleBuilder&action=index&type=studio">Studio</a>.<br>
Per abilitare i moduli per le ricerche globali in SugarCRM Mobile e Sugar Portal, utilizzare <a href="index.php?module=Administration&action=UnifiedSearchSettings">Configurazione di ricerca globale legacy</a>. <br>
Per ulteriori informazioni, fare riferimento alla documentazione <a href="https://www.sugarcrm.com/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=FullTextSearch">Cerca</a>.',
    'LBL_UNIFIED_SEARCH_SETTINGS_TITLE' => 'La ricerca globale precedente verrà utilizzata solo per restituire risultati nelle ricerche globali di SugarCRM Mobile o Sugar Portal. Affinché la ricerca globale legacy possa eseguire una ricerca su un particolare modulo, deve essere abilitata di seguito. <br>
Per abilitare i moduli per la ricerca globale nell&#39;applicazione desktop, utilizzare la <a href="index.php?module=Administration&action=GlobalSearchSettings">Configurazione di ricerca di testo completo</a>. <br>
Per ulteriori informazioni, fare riferimento alla documentazione <a href="https://www.sugarcrm.com/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=LegacyGlobalSearch">Cerca</a>.',
...
Le integrazioni che fanno riferimento a questa piattaforma non funzioneranno più.',
    ...
    'LBL_PIPELINE_LINK_NAME' => 'Impostazioni vista affiancata',
    'LBL_PIPELINE_LINK_DESCRIPTION' => 'Configura vista affiancata',
    'LBL_PIPELINE_SECTION_HEADER' => 'Vista affiancata',
    'LBL_PIPELINE_DEFAULT_SETTING_TITLE' => 'Impostazioni vista affiancata',
    'LBL_PIPELINE_SECTION_DESCRIPTION' => 'Abilita la vista affiancata per diversi moduli e seleziona le colonne e i campi dei riquadri per ognuno.',

    // Cloud Insights
    'LBL_SUGAR_CLOUD_TITLE' => 'SugarCloud',
    'LBL_SUGAR_CLOUD_DESC' => 'Visualizza le informazioni sulle istanze in SugarCloud.',
    'LBL_CLOUD_INSIGHTS' => 'SugarCloud Insights',
    'LBL_CLOUD_INSIGHTS_ADMIN_TITLE' => 'SugarCloud Insights',
    'LBL_CLOUD_INSIGHTS_ADMIN_DESC' => 'Visualizza l&#39;utilizzo di memoria, l&#39;utilizzo della licenza della tua organizzazione e ottieni l&#39;accesso ai registri',
    'LBL_VIEW_CLOUD_INSIGHTS' => 'Visualizza SugarCloud Insights',
    'LBL_FORM_ACCESS_CLOUD_INSIGHT' => 'Accedi a SugarCloud Insights',

    'LBL_AWS' => 'Amazon Web Services',
    'LBL_AWS_DESCR' => 'Configurare Amazon Web Services.',
    'LBL_AWS_CONNECT_SAVED' => 'Le impostazioni di Amazon Connect sono state salvate',
    'LBL_AWS_CONNECT_TITLE' => 'Impostazioni Amazon Connect',
    'LBL_AWS_CONNECT_DESCR' => 'Configurare Amazon Connect per l&#39;uso in Sugar',
    'LBL_AWS_CONNECT_REGION' => 'Regione istanza',
    'LBL_AWS_CONNECT_INST_NAME' => 'Nome istanza',
    ...
    'LBL_AWS_CONNECT_REGION_HELP_TEXT' => 'Inserire la regione (ad es. "us-west-2") dell&#39;istanza Amazon Connect. La regione può essere trovata nella console Amazon.',
    'LBL_AWS_CONNECT_INST_NAME_HELP_TEXT' => 'Inserire il nome dell&#39;istanza Amazon Connect. Ad esempio, nel seguente URL Amazon Connect, il nome dell&#39;istanza è "esempio": https://esempio.awsapps.com/connect/ccp-v2.',
    'LBL_AWS_CONNECT_IDENTITY' => 'Sistema Identity Management',
    'LBL_AWS_CONNECT_IDENTITY_HELP_TEXT' => 'Seleziona come desideri gestire i tuoi utenti. Le opzioni includono l&#39;accesso diretto in Amazon Connect e l&#39;accesso singolo tramite SAML.', // TODO - Add Active Directory help text when needed
    'LBL_AWS_LOGIN_URL' => 'Endpoint URL',
    'LBL_AWS_PANEL_GENERAL' => 'Generale',
    'LBL_AWS_PANEL_CALL_RECORDING' => 'Registrazione chiamata',
    'LBL_AWS_PANEL_PORTAL_CHAT' => 'Chat portale Sugar',
    'LBL_AWS_INSTANCE_INFO' => 'Informazioni istanza',
    'LBL_AWS_PORTAL_CHAT_SETTINGS' => 'Impostazioni',
    'LBL_AWS_PORTAL_ENABLE_CHAT' => 'Abilita chat Amazon Connect',
    'LBL_AWS_PORTAL_API_GATEWAY' => 'Gateway API',
    'LBL_AWS_PORTAL_CONTACT_FLOW_ID' => 'ID Contact Flow',
    'LBL_AWS_CONNECT_INST_ID' => 'ID istanza Amazon Connect',
    'LBL_AWS_PORTAL_API_GATEWAY_HELP_TEXT' => 'Immettere l&#39;URL dell&#39;endpoint di API Gateway utilizzato per avviare una sessione di chat. In Amazon API Gateway, questo è l&#39;URL di richiamo.',
    'LBL_AWS_PORTAL_CONTACT_FLOW_ID_HELP_TEXT' => 'Immettere l&#39;ID del flusso di contatti che si desidera utilizzare nella chat del Portale Sugar. Se un ARN del flusso di contatti è "arn:aws:connect:us-west-2:123456789012:instance/1111/contact-flow/2222", the contact flow ID is "2222".',
    'LBL_AWS_INSTANCE_ID_HELP_TEXT' => 'Inserisci l&#39;ID della tua istanza Amazon Connect da utilizzare nella chat del Portale Sugar. Se l&#39;istanza ARN è "arn:aws:connect:us-west-2:123456789012:instance/1111", l&#39;ID istanza è "1111".',

    'LBL_AWS_CHAT_HEADER' => 'Intestazione',
    'LBL_AWS_CHAT_FOOTER' => 'Piè di pagina',
    'LBL_AWS_CHAT_END_BUTTON' => 'Pulsante Fine chat',
    'LBL_AWS_CHAT_MESSAGES' => 'Messaggi',
    'LBL_AWS_CHAT_TITLE' => 'Titolo',
    'LBL_AWS_CHAT_TITLE_COLOR' => 'Colore titolo',
    'LBL_AWS_CHAT_HEADER_SUBTITLE' => 'Sottotitolo',
    'LBL_AWS_CHAT_HEADER_SUBTITLE_COLOR' => 'Colore sottotitolo',
    'LBL_AWS_CHAT_HEADER_BACKGROUND_COLOR' => 'Colore sfondo',
    'LBL_AWS_CHAT_TEXT_COLOR' => 'Colore testo',
    'LBL_AWS_CHAT_END_BUTTON_FILL' => 'Riempimento pulsante',
    'LBL_AWS_CHAT_END_BUTTON_SIZE' => 'Dimensioni',
    'LBL_AWS_CHAT_END_BUTTON_SIZE_TEXT1' => 'Altezza',
    'LBL_AWS_CHAT_END_BUTTON_SIZE_TEXT2' => 'pixel x larghezza',
    'LBL_AWS_CHAT_END_BUTTON_SIZE_TEXT3' => 'pixel',
    'LBL_AWS_CHAT_CUSTOMER_BUBBLE_COLOR' => 'Colore fumetto chat cliente',
    'LBL_AWS_CHAT_AGENT_BUBBLE_COLOR' => 'Colore fumetto chat agente',
    'LBL_AWS_CHAT_HEADER_TITLE_DEFAULT' => 'Ciao! Sono il tuo assistente di servizio',
    'LBL_AWS_CHAT_HEADER_SUBTITLE_DEFAULT' => 'Inserisci la tua domanda per contattare un rappresentante del servizio clienti',
    'LBL_AWS_CHAT_IMAGE_URL' => 'URL immagine',
    'LBL_AWS_CHAT_URL_TO_FILE' => 'URL per il file immagine',

    'LBL_CSP_SETTING_HELP_TEXT_CONTENT' => 'Questa impostazione rappresenta la direttiva CSP (Content Security Policy) utilizzata dai browser Web per controllare quali risorse possono essere caricate su una pagina Web. Per ulteriori informazioni sui valori e sui formati dei campi accettabili, fare riferimento alla documentazione <a href={{linkToDocumentation}} target="_blank">Sistema</a>.',
    'LBL_CSP_SETTING_SAVED' => 'Le impostazioni sulla Politica sulla sicurezza dei contenuto sono state salvate',
    'LBL_MANAGE_CSP' => 'Definisci il contenuto consentito per iframe e dashlet della pagina Web.',
    'LBL_CSP_TITLE' => 'Impostazioni della Politica sulla sicurezza dei contenuti',
    'LBL_CSP_TRUSTED_DOMAINS' => 'Domini affidabili',
);
