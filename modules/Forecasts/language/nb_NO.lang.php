...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}. <br><br>Merk at områdeinnstillingene ikke kan endres etter den første lagringen. For oppgraderte forekomster, er områdeinnstillingen låst med eksisterende prognosedata.<br><br>Du kan velge to eller flere sannsynlighetsområder eller opprette kategorier som ikke er basert på sannsynlighet. <br><br>Det er avmerkingsruter til venstre for dine egendefinerte kategorier; bruk disse for å bestemme hvilke områder som vil inkluderes i prognosemengden lagret og rapportert til sjefer. <br><br>En bruker kan endre inkluder/ekskluder-statusen og kategorien for {{forecastByModule}} manuelt fra arbeidsarket.',
