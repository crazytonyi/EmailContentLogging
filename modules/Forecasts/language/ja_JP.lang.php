...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '{{forecastByModule}} の分類方法を設定します。<br><br>最初の確定以降に範囲設定を変更することはできないことに注意してください。アップグレード済みのインスタンスの場合、範囲設定は既存の売上予測データによりロックされます。<br><br>確率範囲に基づいて 2 つ以上のカテゴリを選択するか、確率に基づかないカテゴリを作成できます。<br><br>カスタムカテゴリの左側にチェックボックスがあります。 これらを使用して、確定されてマネージャーに報告される予測金額に含まれる範囲を決定します。<br><br>ユーザーは、自分のワークシートから追加/除外ステータスおよび {{forecastByModule}} のカテゴリを変更できます。',
