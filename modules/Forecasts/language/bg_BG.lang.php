...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигурирайте как бихте желали да категоризирате {{forecastByModule}}. <br><br>Обърнете внимание, че настройките за обхват не могат да бъдат променяни след първото изпращане. За надградени екземпляри настройката за обхват е заключена със съществуващи прогнозни данни. <br><br>Можете да изберете две или повече категории на базата на вероятни обхвати или да създадете категории, които не са базирани на вероятност.<br><br>Отляво на Вашите потребителски категории има полета за отметки; използвайте ги, за да решите кои обхвати ще бъдат включени в изпратената прогнозна сума и ще бъдат съобщени на мениджърите. <br><br>Потребителят може да променя статуса на включване/изключване и категорията на {{forecastByModule}} ръчно от плана си.',
