...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Укажите способ классификации {{forecastByModule}}. <br><br>Обратите внимание, что после первого подтверждения нельзя изменить настройки диапазона. Для обновленных экземпляров настройки диапазона блокируются вместе с имеющимися данными прогноза. <br> <br> Можно выбрать две или несколько категорий на основе диапазонов вероятности или создать категории, которые не основываются на вероятности. <br> <br> Слева от пользовательских категорий есть флажки. Установите их возле диапазонов, которые нужно включить в прогноз относительно суммы и отправить руководителям. <br> <br> Пользователь может вручную изменить статус включения/исключения и категорию {{forecastByModule}} со своего рабочего листа.',
