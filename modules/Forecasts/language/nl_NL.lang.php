...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt indelen. <br><br>Houd er rekening mee dat de Bereikinstellingen niet kunnen worden gewijzigd nadat deze zijn bevestigd. Voor geüpgrade exemplaren is de Bereikinstelling vergrendeld in de Voorspellingsgegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheid of u kunt categorieën aanmaken die niet zijn gebaseerd op waarschijnlijkheid. <br><br>Er zijn selectievelden aan de linkerkant van uw aangepaste categorieën; gebruik deze om te bepalen welk bereik is inbegrepen bij het Voorspelde aantal dat is bevestigd en aan managers wordt gerapporteerd. <br><br>Een gebruiker kan de status insluiten/uitsluiten en de categorie {{forecastByModule}} handmatig wijzigen vanuit het werkblad.',
