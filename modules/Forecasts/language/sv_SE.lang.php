...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du skulle vilja kategorisera {{forecastByModule}}. <br><br>Observera att intervallsinställningarna inte går att ändra när de angivits. För uppgraderade instanser låses intervallsinställningen med befintliga prognosdata.<br><br>Du kan välja två eller fler kategorier baserat på sannolikhetsintervall eller skapa kategorier som inte är sannolikhetsbaserade. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier, använd dessa för att besluta vilka intervall som ska ingå i den valda prognosmängden och rapporteras till cheferna. <br><br>En användare kan ändra statusen inkludera/exkludera och kategorin för {{forecastByModule}} manuellt från sitt arbetsblad.',
