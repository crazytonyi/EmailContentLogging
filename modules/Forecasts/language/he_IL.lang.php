...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר כיצד ברצונך לסווג את {{forecastByModule}} לקטגוריות. <br><br>שים לב: לא ניתן לשנות את הגדרות הטווח לאחר ההתחייבות הראשונה. עבור מופעים משודרגים, הגדרת הטווח נעולה על נתוני התחזית הקיימים.<br><br>ניתן לבחור שתי קטגוריות או יותר המבוססות על טווחי סבירות, או ליצור קטגוריות שאינן מבוססות על סבירות. <br><br>לצד הקטגוריות המותאמות אישית ישנן תיבות סימון; השתמש בהן כדי לקבוע אילו טווחים ייכללו בסכום הצפוי שעליו ניתנה התחייבות וידווחו למנהלים. <br><br>משתמש רשאי לשנות את סטטוס ההכללה/אי-הכללה ואת הקטגוריה של {{forecastByModule}} ידנית מגליון העבודה שלו.',
