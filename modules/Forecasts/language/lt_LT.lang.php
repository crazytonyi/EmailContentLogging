...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigūruokite, kaip norėtumėte skirstyti į kategorijas {{forecastByModule}}. <br><br>Atkreipkite dėmesį, kad diapazono nustatymai negali būti pakeisti po pirmo įsipareigojimo. Naujovintuose egzemplioriuose diapazono nustatymas užrakintas pagal esamus prognozės duomenis. <br> <br> Galite pasirinkti dvi ar daugiau kategorijų pagal tikimybės diapazonus arba sukurti kategorijas, kurios nėra pagrįstos tikimybe. <br> <br> Yra žymės langeliai kairėje jūsų pasirinktinių kategorijų; naudokitės jais nuspręsdami, kurie intervalai bus įtraukti į numatomą prognozės sumą ir apie kurią pranešta vadovams. <br><br>Vartotojas iš savo darbalapio gali rankiniu būdu pakeisti {{forecastByModule}} įtraukimo / neįtraukimo būseną ir kategoriją.',
