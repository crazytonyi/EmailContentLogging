...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '配置要如何对 {{forecastByModule}} 进行分类。<br><br>请注意，“范围”设置在首次提交后将无法再更改。对于升级的实例，“范围”设置将与现有的“预测”数据锁定。<br><br>您可以基于概率范围选择两个或多个类别，或者创建不基于概率的类别。<br><br>自定义类别左侧有复选框；使用这些复选框可以确定哪些范围将包含在提交并报告给经理的预测金额中。<br><br>用户可以从工作表中手动更改 {{forecastByModule}} 的包含/排除状态和类别。',
