...
$mod_strings = array(
    ...
    'LBL_PRODUCTS_FOCUS_DRAWER_DASHBOARD' => 'Фокусна панель продуктів комерційної пропозиції',
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Загальна кількість позицій каталогу продуктів',
    ...
    'LBL_ADD_ON_TO' => 'Доповнення до',
    'LBL_ADD_ON_TO_ID' => 'Ідентифікатор доповнення до',
