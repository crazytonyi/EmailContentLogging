...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Prodane stavke: početno',
    'LBL_SEARCH_FORM_TITLE' => 'Pretraživanje prodanih stavki',
    'LBL_LIST_FORM_TITLE' => 'Popis prodanih stavki',
    'LBL_NEW_FORM_TITLE' => 'Stvori prodanu stavku',
    'LBL_PRODUCT' => 'Prodana stavka:',
    'LBL_RELATED_PRODUCTS' => 'Povezane prodane stavke',
    'LBL_LEAD_SOURCE' => 'Izvor poten. klijenta',
    'LBL_LIST_NAME' => 'Prodana stavka',
    ...
    'LBL_ASSOCIATED_QUOTE' => 'Predmet ponude:',
    ...
    'LBL_SELECT_DISCOUNT' => 'Odabir popusta',
    ...
    'LNK_PRODUCT_LIST' => 'Prikaži prodane stavke',
    'LNK_NEW_PRODUCT' => 'Stvori prodanu stavku',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Prodane stavke',
    'LBL_RELATED_PRODUCTS_TITLE' => 'Prodane stavke',
    ...
    'LBL_ADD_ON_TO' => 'Dodaj na',
    'LBL_ADD_ON_TO_ID' => 'Dodaj na ID',

    'LBL_CONVERT_TO_QUOTE_ERROR' => 'Pogreška:',
    'LBL_CONVERT_TO_QUOTE_ERROR_MESSAGE' => 'Došlo je do pogreške pri pretvaranju ove prodane stavke u ponudu',

    'LBL_DISCOUNT_AS_PERCENT' => 'Popust u %',

    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} sastoji se od svih proizvoda koji su prodani ili su u postupku prodaje klijentima. Popis proizvoda koje vaša organizacija prodaje nalazi se u Administrator > Katalog proizvoda te administratori mogu po potrebi dodavati proizvode. Pri stvaranju modula {{plural_module_name}}, imate mogućnost odabrati proizvode iz kataloga ili stvoriti nove proizvode putem modula {{plural_module_name}}. Module {{plural_module_name}} u Sugaru možete stvoriti na različite načine, kao primjerice putem modula {{plural_module_name}}, modula {{quotes_module}}, dupliciranjem, uvoženjem modula {{plural_module_name}} itd. Nakon što stvorite zapis o modulu {{module_name}}, možete vidjeti i urediti informacije koje pripadaju modulu {{module_name}} putem prikaza zapisa o modulu {{plural_module_name}}.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} sastoji se od svih proizvoda koji su prodani ili su u postupku prodaje klijentima. 
...
- Dodatne radnje dostupne su u padajućem izborniku Radnje koji se nalazi desno od gumba Uredi.',
    ...
    'LBL_HELP_CREATE' => 'Modul {{plural_module_name}} sastoji se od svih proizvoda koji su prodani ili su u postupku prodaje klijentima. 
...
2. Kliknite na „Spremi” da biste završili novi zapis i vratili se na prethodnu stranicu.',
    ...
    'LBL_PRODUCT_POSITION' => 'Položaj paketa proizvoda',
