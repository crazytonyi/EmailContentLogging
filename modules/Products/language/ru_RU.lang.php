...
$mod_strings = array(
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Общее количество позиций каталога продуктов',
    ...
    'LBL_DISCOUNT_AMOUNT_VALUE' => 'Значение суммы скидки',
    ...
    'LBL_ADD_ON_TO' => 'Дополнение к',
    'LBL_ADD_ON_TO_ID' => 'Идентификатор дополнения к',
