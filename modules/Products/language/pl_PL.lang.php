...
$mod_strings = array(
    ...
    'LNK_PRODUCT_LIST' => 'Wyświetl pozycje oferty',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduł {{plural_module_name}} zawiera wszystkie produkty, które zostały już sprzedane lub są w trakcie sprzedaży klientom. Lista produktów sprzedawanych przez Twoją firmę znajduje się w: Administracja > Katalog produktów; administratorzy mają możliwość dodawania produktów w razie potrzeby. Podczas tworzenia rekordów typu {{plural_module_name}} możesz wybrać produkty z katalogu bądź utworzyć nowy produkt za pomocą modułu {{plural_module_name}}. Jest kilka sposobów na utworzenie rekordów typu {{plural_module_name}} w Sugar, np. poprzez moduł {{plural_module_name}}, moduł {{quotes_module}}, duplikowanie, importowanie modułów {{plural_module_name}} itp. Po utworzeniu rekordu typu {{module_name}}, możesz przeglądać i edytować informacje dotyczące modułu {{module_name}} poprzez widok rekordu {{plural_module_name}}.',
