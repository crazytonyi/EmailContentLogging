...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_FORM_LABEL_EMAIL_PROCESS_USER' => 'Eメール',
    'LBL_PA_FORM_LABEL_EMAIL_PROCESS_USER' => 'プロセス割り当て時のEメールプロセス ユーザー',
    ...
    'LBL_PA_FORM_LABEL_SET_BY_AVAILABILITY' => '在庫別に「アサイン先」を設定',
    ...
    'LBL_PMSE_FORM_REQUIRED_SHIFT_AVAILABILITY' => '必須シフトの可用性',
    'LBL_PMSE_FORM_LABEL_IF_NO_AVAILABLE' => '使用可能なユーザがいない場合',

    'LBL_PMSE_FORM_LABEL_BEFORE' => '以前',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_HOURS' => '営業時間',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_CENTER' => 'ビジネスセンター',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_CENTER_FROM_TARGET_MODULE' => 'ターゲットモジュールから',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_CENTER_FROM' => '送信元',
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_CENTER_MODULE' => 'モジュール',
    ...
    'LBL_PMSE_EXPCONTROL_OPERATOR_MULTISELECT_IS_ON_OF' => '含まれる',
    ...
    'LBL_PMSE_EMAILPICKER_ALL_ASSIGNED_TEAMS' => '全チームはレコードに割り当てられています',
