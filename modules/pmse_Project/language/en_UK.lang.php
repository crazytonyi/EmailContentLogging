...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_EXPCONTROL_CONSTANTS_TIMESPAN_BUSINESS_CENTER' => 'Business Centre',
    ...
    'LBL_PMSE_EXPCONTROL_OPERATOR_MULTISELECT_IS_ON_OF' => 'is one of',
    ...
    'LBL_PMSE_ERROR_FLOW_INCOMING_MAXIMUM_INFO' => 'This element has a minimum number of incoming paths that must not be exceeded. Check the number of paths that connect to this element to make sure that minimum number is not exceeded.',

    'LBL_PMSE_ERROR_FLOW_OUTGOING_MINIMUM' => 'Element does not meet the minimum number of outgoing flows',
    'LBL_PMSE_ERROR_FLOW_OUTGOING_MINIMUM_INFO' => 'This element must have a minimum number of outgoing paths. Check the number of paths leading out of this element to make sure that the minimum number is met.',

    'LBL_PMSE_ERROR_FLOW_OUTGOING_MAXIMUM' => 'Element exceeds the maximum number of outgoing flows',
    'LBL_PMSE_ERROR_FLOW_OUTGOING_MAXIMUM_INFO' => 'This element has a maximum number of outgoing paths that must not be exceeded. Check the number of paths leading out of this element to make sure that the maximum number is not exceeded.',
    ...
    'LBL_PMSE_ERROR_DATA_NOT_FOUND' => 'Data do not currently exist in the system',
    'LBL_PMSE_ERROR_DATA_NOT_FOUND_INFO' => 'The settings for this element reference a specific data item that does not exist in the database. Check the element settings to ensure that all data referenced exist (i.e. specific users, module fields, teams, etc.).',
    ...
    'LBL_PMSE_ERROR_ELEMENT_UNREACHABLE_INFO' => 'In order for an element to be executed in a process, it must have a path connected to it. The chain of paths leading to this element must begin with a start element. Check the chain of incoming paths to this element to make sure that the chain begins with a start element.',
