...
'help'=>array(
    ...
    . '<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.'
    ,
        'defaultquickcreate'=>'Oblasť <b>Rozloženie</b> obsahuje polia, ktoré sa momentálne zobrazujú vo formulári <b>Rýchle vytvorenie</b>.<br><br>Formulár Rýchle vytvorenie sa zobrazí v podpaneloch pre modul pri kliknutí na tlačidlo Vytvoriť.<br/><br/>Časť <b>Nástroje</b> obsahuje <b>Kôš</b> a polia a prvky rozloženia, ktoré do rozloženia možno pridať.<br><br>Vykonajte zmeny v rozložení pretiahnutím prvkov a polí medzi časťami <b>Nástroje</b> a <b>Rozloženie</b> a v rámci samotného rozloženia.<br><br>Ak chcete pole z rozloženia odstrániť, pretiahnite pole do priečinka <b>Kôš</b>. Pole potom bude k dispozícii v časti Nástroje na prípadné pridanie do rozloženia.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.'
    ,
...
'LBL_RECORDDASHLETVIEW'=>'Dashlet zobrazenia záznamu',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_INFO_ERROR' => 'Musí byť určený aspoň jeden spôsob kontaktu',
    ...
    'LBL_PORTAL_MODULES' => 'Moduly portálu',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => 'Kontaktné informácie portálu',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => 'Nakonfigurujte kontaktné informácie, ktoré sú prezentované používateľom portálu, ktorí požadujú ďalšiu pomoc so svojím účtom. Musí byť nakonfigurovaná aspoň jedna možnosť.',
...
'LBL_CONFIRM_FIELD_DELETE'=>'Vymazaním tohto vlastného poľa odstránite vlastné pole a všetky údaje súvisiace s vlastným poľom v databáze. Pole sa už nebude zobrazovať v žiadnom z rozložení modulu.'
        ...
        . '\n\nChcete pokračovať?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Naozaj chcete odstrániť tento vzťah?<br>Poznámka: Vykonanie tejto operácie môže trvať niekoľko minút.',
...
'LBL_POPHELP_CALCULATED'=>"Vytvorte vzorec na určenie hodnoty v tomto poli.<br>"
   ...
   . "Polia používajúce vzorce sa nebudú vypočítavať v reálnom čase "
   . "v Samoobslužnom portáli Sugar alebo "
...
'LBL_POPHELP_DEPENDENT'=>"Vytvorte vzorec na určenie toho, či je toto pole viditeľné v rozloženiach.<br/>"
        ...
        . "ale nebudú sa riadiť vzorcom v natívnych aplikáciach, ako je napríklad Sugar Mobile pre iPhone. <br/>"
        . "Nebudú sa riadiť vzorcom v Samoobslužnom portáli Sugar.",
'LBL_POPHELP_REQUIRED'=>"Vytvorte vzorec na určenie toho, či je toto pole povinné v rozloženiach.<br/>"
    . "Povinné polia sa budú riadiť vzorcom v zobrazení v prehliadači v mobilných zariadeniach, <br/>"
    . "ale nebudú sa riadiť vzorcom v natívnych aplikáciach, ako je napríklad Sugar Mobile pre iPhone. <br/>"
    . "Nebudú sa riadiť vzorcom v Samoobslužnom portáli Sugar.",
'LBL_POPHELP_READONLY'=>"Vytvorte vzorec na určenie toho, či je toto pole v rozloženiach určené iba na čítanie.<br/>"
        . "Polia iba na čítanie sa budú riadiť vzorcom v zobrazení v prehliadači v mobilných zariadeniach, <br/>"
        . "ale nebudú sa riadiť vzorcom v natívnych aplikáciach, ako je napríklad Sugar Mobile pre iPhone. <br/>"
        . "Nebudú sa riadiť vzorcom v Samoobslužnom portáli Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Toto pole vyberte na používanie pri vyhľadávaní záznamov pomocou globálneho vyhľadávania v tomto module.',
