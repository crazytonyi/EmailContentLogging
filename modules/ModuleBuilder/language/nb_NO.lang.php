...
'LBL_RECORDDASHLETVIEW'=>'Registrer visningsdashlet',
...
'LBL_POPHELP_READONLY'=>"Opprett en formel for å fastslå om dette feltet er nødvendig i oppsett.<br/>"
        . "Obligatoriske felt vil følge formelen i den nettleserbaserte mobilvisningen, <br/>"
        . "men vil ikke følge formelen i de innebygde applikasjonene, som Sugar Mobile for iPhone. <br/>"
        . "De vil ikke følge formelen i Sugars selvbetjeningsportal.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Velg for å bruke dette feltet når du søker etter oppføringer ved bruk av globalt søk på denne modulen.',
