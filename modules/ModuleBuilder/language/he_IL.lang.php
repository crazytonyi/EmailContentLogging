...
'LBL_RECORDDASHLETVIEW'=>'חלונית תצוגת רשומה',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_URL' => 'כתובת URL',
    'LBL_PORTAL_CONTACT_INFO_ERROR' => 'יש לציין לפחות שיטה אחת ליצירת קשר',
    ...
    'LBL_PORTAL_MODULES' => 'מודולים של הפורטל',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => 'פרטי יצירת קשר עבור הפורטל',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => 'הגדר את פרטי יצירת הקשר שיוצגו למשתמשי הפורטל אשר יזדקקו לסיוע נוסף לגבי החשבון שלהם. יש להגדיר לפחות אפשרות אחת.',
...
'LBL_POPHELP_READONLY'=>"צור נוסחה כדי לקבוע אם שדה זה יוגדר לקריאה בלבד בתצורות.<br/>"
        . "שדות לקריאה בלבד יוצגו לפי הנוסחה בתצוגה מבוססת-דפדפן במכשירים ניידים, <br/>"
        . "אבל לא לפי הנוסחה באפליקציות המקוריות, כמו Sugar Mobile ל-iPhone. <br/>"
        . "הם לא יוצגו לפי הנוסחה בפורטל לשירות עצמי של Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'בחר כדי להשתמש בשדה זה בעת חיפוש רשומות באמצעות חיפוש גלובלי במודול זה.',
