...
'LBL_CONFIG_PORTAL_LOGOMARK_URL'=> 'URL σε προσαρμοσμένη εικόνα σήματος λογότυπου. Οι συνιστώμενες διαστάσεις του σήματος λογότυπου είναι 22 x 22 εικονοστοιχεία. Οποιαδήποτε εικόνα μεταφορτώθηκε και είναι μεγαλύτερη σε κάθε κατεύθυνση θα κλιμακωθεί σε αυτές τις μέγιστες διαστάσεις.',
'LBL_CONFIG_PORTAL_LOGO_URL'=> 'URL σε προσαρμοσμένη εικόνα λογότυπου. Το συνιστώμενο πλάτος λογότυπου είναι 200 pixels. Οποιαδήποτε εικόνα μεταφορτώθηκε και είναι μεγαλύτερη σε κάθε κατεύθυνση θα κλιμακωθεί σε αυτές τις μέγιστες διαστάσεις. Αυτό το λογότυπο θα χρησιμοποιηθεί στην οθόνη σύνδεσης. Αν δεν μεταφορτωθεί εικόνα, θα χρησιμοποιηθεί το λογότυπο.',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_LOGOMARK_URL' => 'Διεύθυνση URL σήματος λογότυπου',
    'LBL_PORTAL_LOGOMARK_PREVIEW' => 'Προεπισκόπηση σήματος λογότυπου',
    'LBL_PORTAL_LOGO_URL' => 'Διεύθυνση URL Λογότυπου',
    'LBL_PORTAL_LOGO_PREVIEW' => 'Προεπισκόπηση λογότυπου',
...
'LBL_POPHELP_READONLY'=>"Δημιουργήστε έναν τύπο για να προσδιορίσετε εάν αυτό το πεδίο είναι μόνο για ανάγνωση σε διατάξεις.<br/>"
        ...
        . "αλλά δεν θα ακολουθήσουν τον τύπο στις εγγενείς εφαρμογές, όπως το Sugar Mobile για iPhone. <br/>"
        . "Δεν θα εφαρμόσουν τον τύπο στο Portal Sugar Self-Service.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Επιλέξτε για να χρησιμοποιήσετε αυτό το πεδίο κατά την αναζήτηση εγγραφών χρησιμοποιώντας την καθολική αναζήτηση σε αυτήν την ενότητα.',
