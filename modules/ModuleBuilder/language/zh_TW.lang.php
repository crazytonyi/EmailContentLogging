...
'LBL_RECORDDASHLETVIEW'=>'紀錄 Dashlet 視圖',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_INFO_ERROR' => '必須至少指定一種聯繫方式',
    ...
    'LBL_PORTAL_MODULES' => '門戶模塊',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => '門戶聯絡訊息',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => '配置像門戶用戶提供的聯絡訊息，當用戶需要額外幫助來使用其帳戶時，可看到這一訊息。必須至少配置一個選項。',
...
'LBL_POPHELP_READONLY'=>"建立公式以確定這個字段在布局中是否為唯讀。<br/>"
        ...
        . "但不會遵循本地應用程式中的公式，比如用於 iPhone 的 Sugar Mobile。 <br/>"
        . "他們不會遵循 Sugar 自助服務門戶中的公式。",
'LBL_POPHELP_GLOBAL_SEARCH'=>'在此模組中使用全局搜索來搜索紀錄時，選擇使用此字段。',
