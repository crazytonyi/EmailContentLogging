...
'LBL_RECORDDASHLETVIEW'=>'Панел Изглед на запис',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_INFO_ERROR' => 'Трябва са посочи поне един метод за контакт',
    ...
    'LBL_PORTAL_MODULES' => 'Модули на портал',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => 'Информация за контакти на портала',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => 'Конфигурирайте информацията за контакти, която се представя на потребителите на портала, които се нуждаят от допълнително съдействие за техния акаунт. Трябва да се конфигурира поне една опция.',
...
'LBL_POPHELP_READONLY'=>"Създайте формула, за да определите дали това поле е задължително в оформления.<br/>"
        ...
        . "но няма да следват формулата в основните приложения като Sugar Mobile for iPhone. <br/>"
        . "Те няма да бъдат след формулата в портала за самообслужване на Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Изберете да използвате това поле, когато търсите записи с помощта на глобалното търсене на този модул.',
