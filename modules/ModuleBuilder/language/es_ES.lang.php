...
'LBL_RECORDDASHLETVIEW'=>'Dashlet de la vista de registros',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_INFO_ERROR' => 'Se debe especificar al menos un método de contacto',
    ...
    'LBL_PORTAL_MODULES' => 'Módulos del Portal',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => 'Información de contacto del Portal',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => 'Configure la información de contacto que se presenta a los usuarios del Portal que necesiten ayuda adicional con su cuenta. Se debe configurar al menos una opción.',
...
'LBL_POPHELP_REQUIRED'=>"Crear una fórmula para determinar si este campo es obligatorio en los diseños.<br/>"
...
'LBL_POPHELP_READONLY'=>"Crear una fórmula para determinar si este campo es de solo lectura en los diseños.<br/>"
        . "Los campos de solo lectura seguirán la fórmula en la vista móvil basada en navegador, <br/>"
        . "pero no seguirán la fórmula en las aplicaciones nativas, como Sugar Mobile para iPhone. <br/>"
        . "No seguirán la fórmula en el Portal autoservicio de Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Selecciónela para utilizar este campo al buscar registros con la Búsqueda global en este módulo.',
