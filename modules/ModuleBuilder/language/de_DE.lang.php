...
'LBL_RECORDDASHLETVIEW'=>'Datensatzansicht-Dashlet',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_CONTACT_INFO_ERROR' => 'Es muss mindestens eine Kontaktmethode angegeben werden',
    ...
    'LBL_PORTAL_MODULES' => 'Module des Portals',
    'LBL_CONFIG_PORTAL_CONTACT_INFO' => 'Kontaktinformationen des Portals',
    'LBL_CONFIG_PORTAL_CONTACT_INFO_HELP' => 'Konfigurieren Sie die Kontaktinformationen, die den Benutzern des Portals angezeigt werden, die zusätzliche Unterstützung für ihr Konto benötigen. Es muss mindestens eine Option konfiguriert sein.',
...
'LBL_POPHELP_READONLY'=>"Erstellen Sie eine Formel, um festzustellen, ob dieses Feld in Layouts schreibgeschützt ist.<br/>"
        . "Schreibgeschützte Felder folgen zwar der Formel in der browserbasierten mobilen Ansicht, <br/>"
        . "jedoch nicht der Formel in nativen Anwendungen wie Sugar Mobile für iPhone. <br/>"
        . "Sie folgen nicht der Formel im Sugar Self-Service Portal.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Wählen Sie, um dieses Feld zu verwenden, wenn Sie mithilfe der globalen Suche in diesem Modul nach Datensätzen suchen.',
