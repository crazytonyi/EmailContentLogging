...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu vormil <b>Kiirloomine</b>.<br><br>Kiirloomise vorm ilmub pärast loomisnupu klõpsamist mooduli alampaneelidel.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ja <b>Paigutus</b> vahel ning paigutuses endas.<br><br>Välja eemaldamiseks paigutusest lohistage väli kohta <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab sõltuvale väljale, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab arvutatud väljale, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        //this defualt will be used for edit view
        'default'	=> 'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu jaotises <b>Redigeerimisvaade</b>.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ja <b>Paigutus</b> vahel ning paigutuses endas.<br><br>Välja eemaldamiseks paigutusest lohistage väli jaotisesse <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab sõltuvale väljale, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab arvutatud väljale, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_FIELD_DELETE'=>'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\n\nKas soovite jätkata?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas soovite kindlasti selle suhte kustutada?<br>Märkus. Selle toimingu lõpuleviimiseks võib kuluda mitu minutit.',
...
,
'LBL_POPHELP_CALCULATED'=>"Looge valem, et määrata selle välja väärtus.<br>"
   . "Töövoo definitsioonid, millele on määratud selle välja värskendamise toiming, ei käivita enam toimingut.<br>"
   . "Valemeid kasutavaid välju ei arvutata reaalajas funktsioonis "
   . "Sugari iseteenindusportaalis või "
   . "Redigeerimisvaate paigutused mobiilis.",
...
'LBL_POPHELP_DEPENDENT'=>"Looge valem, et määrata, kas see väli on paigutustes nähtav.<br/>"
        ...
        . "ent ei järgi valemit omarakendustes, näiteks iPhone’ile mõeldud Sugar Mobile’is.<br/>"
        . "Need ei järgi valemit Sugari iseteenindusportaalis.",
'LBL_POPHELP_REQUIRED'=>"Looge valem, et määrata, kas see väli on paigutustes nõutav.<br/>"
    . "Nõutavad väljad järgivad valemit brauseripõhises mobiilivaates, <br/>"
    . "ent ei järgi valemit omarakendustes, näiteks iPhone’ile mõeldud Sugar Mobile’is.<br/>"
    . "Need ei järgi valemit Sugari iseteenindusportaalis.",
'LBL_POPHELP_READONLY'=>"Looge valem, et määrata, kas see väli on paigutustes kirjutuskaitstud.<br/>"
        . "Kirjutuskaitstud väljad järgivad valemit brauseripõhises mobiilivaates, <br/>"
        . "ent ei järgi valemit omarakendustes, näiteks iPhone’ile mõeldud Sugar Mobile’is.<br/>"
        . "Need ei järgi valemit Sugari iseteenindusportaalis.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige see, et kasutada välja moodulis globaalse otsingu abil kirjeid otsides.',
