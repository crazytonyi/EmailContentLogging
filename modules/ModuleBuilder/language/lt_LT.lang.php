...
'LBL_CONFIRM_FIELD_DELETE'=>'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete.'
        ...
        . '\n\nAr norite tęsti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Ar tikrai norite ištrinti šiuos santykius?<br>Pastaba. Ši operacija gali būti nebaigta kelias minutes.',
...
,
'LBL_POPHELP_CALCULATED'=>"Sukurkite formulę, kad nustatytumėte šio lauko vertę.<br>"
   . "Darbo eigos apibrėžimai, kuriuose yra veiksmas, nustatytas atnaujinti šį lauką, veiksmas nebebus vykdomas.<br>"
   . "Laukai, kuriuose naudojama formulė, nebus skaičiuojami realiuoju laiku "
...
'LBL_POPHELP_REQUIRED'=>"Sukurkite formulę, kad nustatytumėte, ar šis laukas reikalingas maketuose.<br/>"
    ...
    . "Jie nesilaikys „Sugar“ savitarnos portalo formulės.",
'LBL_POPHELP_READONLY'=>"Sukurkite formulę, kad nustatytumėte, ar šį lauką galima tik skaityti maketuose.<br/>"
        . "Laukai, kuriuos galima tik skaityti, bus naudojami pagal naršyklės mobiliajame rodinyje pateiktą formulę, <br/>"
        . "tačiau nesilaikys formulės savosiose programose, pvz., „Sugar Mobile for iPhone“. <br/>"
        . "Jie nesilaikys „Sugar“ savitarnos portalo formulės.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Pasirinkite, jei norite naudoti šį lauką ieškodami įrašų naudodamiesi šio modulio bendrąja paieška.',
