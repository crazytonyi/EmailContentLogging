...
$mod_strings = array (
    ...
    'LBL_QUOTES_FOCUS_DRAWER_DASHBOARD' => 'Panel de enfoque en los presupuestos',
    ...
    'LBL_BILLING_ACCOUNT_ID' => 'ID de cuenta de facturación',
    ...
    'LBL_SHIPPING_ACCOUNT_ID' => 'ID de la cuenta de envío',
    ...
    'LBL_TOTAL_USDOLLAR'=>'Total general (Dólares EEUU)',
    'LBL_TOTAL' => 'Total general',
    'LBL_TYPE'=>'Tipo',
    ...
    'LBL_QUOTE_CONFIG_SUMMARY_TITLE' => 'Encabezamiento de la barra de resumen',
    'LBL_QUOTE_CONFIG_FOOTER_TITLE' => 'Pie de los totales generales',
    'LBL_CONFIG_FIELD_SELECTOR' => '{{moduleName}} Configuration Field Selector',
    'LBL_WORKSHEET_COLUMNS_PREVIEW' =>'Worksheet Columns Preview',
    'LBL_CONFIG_DIRECTIONS' => 'Instrucciones',
    'LBL_HELP_MORE_INFO' => 'Consulte la {{{more_info_url}}} documentación de configuración de presupuestos {{{more_info_url_close}}} para obtener instrucciones.',
    'LBL_CONFIG_COLUMNS_DIRECTIONS_1' => 'Los siguientes campos aparecerán de manera predeterminada en las columnas de la hoja de cálculo: ',
    'LBL_CONFIG_COLUMNS_RESTORE_DEFAULTS' => 'Restore Defaults',
    'LBL_CONFIG_SUMMARY_COLUMNS_DIRECTIONS_1' => 'Los siguientes campos aparecerán de manera predeterminada en el encabezado de la barra de resumen: ',
    ...
    'LBL_CONFIG_LEGEND_HELP_TEXT' => 'Otros campos de la página están utilizando los campos relacionados y no serán visibles para el usuario.' .
        'Los campos se marcan automáticamente como relacionados si se incluyen en la fórmula de un campo calculado visible.' .
        'Puede exponer un campo relacionado a los usuarios si marca su casilla de verificación, pero no lo podrá quitar si no quita los campos que lo utilizan.',
    'LBL_CONFIG_' => '',
    'LBL_CONFIG_TOOLTIP_FIELD_REQUIRED_BY' => 'This field is required by:',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_PREVIEW' =>'Vista previa del encabezamiento de la barra de resumen',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_MAX_WARNING' =>'Solo se muestran seis (6) campos en la barra de resumen, Quite uno o más campos antes de añadir cualquier otro.',

    'LBL_CONFIG_GRAND_TOTAL_FOOTER_PREVIEW' =>'Vista previa del pie de página de totales generales',
    'LBL_CONFIG_GRAND_TOTAL_FOOTER_DIRECTIONS_1' => 'Los siguientes campos aparecerán de manera predeterminada en el pie de página de los totales generales: ',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_1' => 'Campos de subtotales',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_2' => 'Suelte aquí los campos para añadirlos a la zona de subtotales sobre la línea de Total general.',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_1' => 'Campos de totales generales',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_2' => 'Suelte aquí los campos para añadirlos debajo de la línea de Total general.',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_3' => 'Si no se añaden campos aquí, la línea de Total general se quitará de la vista.',
