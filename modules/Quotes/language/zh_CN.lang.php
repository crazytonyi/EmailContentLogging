...
$mod_strings = array (
    ...
    'LBL_BILLING_ACCOUNT_ID' => '付款账户 ID',
    ...
    'LBL_SHIPPING_ACCOUNT_ID' => '收货账户 ID',
    ...
    'LBL_QUOTE_CONFIG_SUMMARY_TITLE' => '摘要栏标题',
    'LBL_QUOTE_CONFIG_FOOTER_TITLE' => '总计页脚',
    'LBL_CONFIG_FIELD_SELECTOR' => '{{moduleName}} Configuration Field Selector',
    'LBL_WORKSHEET_COLUMNS_PREVIEW' =>'Worksheet Columns Preview',
    'LBL_CONFIG_DIRECTIONS' => '指示',
    'LBL_HELP_MORE_INFO' => '有关说明，请参阅 {{{more_info_url}}} 报价单配置文档 {{{more_info_url_close}}}。',
    'LBL_CONFIG_COLUMNS_DIRECTIONS_1' => '默认情况下，工作表列中显示以下字段：',
    'LBL_CONFIG_COLUMNS_RESTORE_DEFAULTS' => 'Restore Defaults',
    'LBL_CONFIG_SUMMARY_COLUMNS_DIRECTIONS_1' => '默认情况下，摘要栏标题中显示以下字段：',
    ...
    'LBL_CONFIG_LEGEND_HELP_TEXT' => '相关字段由页面上的其他字段使用，且对用户不可见。' .
        '如果字段包含在可见的计算字段公式中, 则自动标记为“相关”。' .
        '您可以通过标记相关字段的复选框向用户公开相关字段，但是您无法删除相关字段，除非您删除了使用相关字段的字段。',
    'LBL_CONFIG_' => '',
    'LBL_CONFIG_TOOLTIP_FIELD_REQUIRED_BY' => 'This field is required by:',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_PREVIEW' =>'摘要栏标题预览',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_MAX_WARNING' =>'摘要栏中只能显示六 (6) 个字段。请删除一个或多个字段，然后再添加任何其他字段。',

    'LBL_CONFIG_GRAND_TOTAL_FOOTER_PREVIEW' =>'总计页脚预览',
    'LBL_CONFIG_GRAND_TOTAL_FOOTER_DIRECTIONS_1' => '默认情况下，总计页脚中显示以下字段：',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_1' => '小计字段',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_2' => '将字段放在此处，以便将其添加至总计行上方的小计区域内。',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_1' => '总计字段',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_2' => '将字段放在此处，以便将其添加到下列总计行中。',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_3' => '如果此处未添加任何字段，总计行将从视图中删除。',
