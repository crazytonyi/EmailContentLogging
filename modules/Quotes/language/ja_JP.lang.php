...
$mod_strings = array (
    ...
    'LBL_QUOTES_FOCUS_DRAWER_DASHBOARD' => '見積フォーカス ドロワ',
    ...
    'LBL_QUOTE_CONFIG_SUMMARY_TITLE' => 'サマリーバーのヘッダー',
    'LBL_QUOTE_CONFIG_FOOTER_TITLE' => '総計のフッター',
    'LBL_CONFIG_FIELD_SELECTOR' => '{{moduleName}} Configuration Field Selector',
    'LBL_WORKSHEET_COLUMNS_PREVIEW' =>'Worksheet Columns Preview',
    'LBL_CONFIG_DIRECTIONS' => '順序',
    'LBL_HELP_MORE_INFO' => '作業の流れについては{{{more_info_url}}}見積設定ドキュメント{{{more_info_url_close}}}をご覧ください。',
    'LBL_CONFIG_COLUMNS_DIRECTIONS_1' => 'デフォルトでは、ワークシートの各列に次のフィールドが表示されます：',
    'LBL_CONFIG_COLUMNS_RESTORE_DEFAULTS' => 'Restore Defaults',
    'LBL_CONFIG_SUMMARY_COLUMNS_DIRECTIONS_1' => 'デフォルトでは、サマリーバーのヘッダーに次のフィールドが表示されます：',
    ...
    'LBL_CONFIG_LEGEND_HELP_TEXT' => '関連するフィールドはページの他のフィールドによって使用されており、ユーザーに表示されません。' .
        '表示される計算後のフィールドについては、フィールドが数式に含まれている場合、関連しているフィールドとして自動的にマークされます。' .
        'ボックスにチェックを入れれば関連するフィールドをユーザーが利用できるようにすることができますが、それを使用するフィールドを削除しない限り、関連するフィールドを削除することができません。',
    'LBL_CONFIG_' => '',
    'LBL_CONFIG_TOOLTIP_FIELD_REQUIRED_BY' => 'This field is required by:',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_PREVIEW' =>'サマリーバーのヘッダーのプレビュー',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_MAX_WARNING' =>'サマリーバーには6件のフィールドしか表示できません。一部のフィールドを削除してから追加してください。',

    'LBL_CONFIG_GRAND_TOTAL_FOOTER_PREVIEW' =>'総計のフッターのプレビュー',
    'LBL_CONFIG_GRAND_TOTAL_FOOTER_DIRECTIONS_1' => 'デフォルトでは、総計のフッターに次のフィールドが表示されます：',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_1' => '小計フィールド',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_TOTAL_2' => 'フィールドをこちらにドロップすれば、総計の行の上にある小計の部分に追加できます。',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_1' => '総計フィールド',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_2' => 'フィールドをこちらにドロップすれば、総計の行の下に追加できます。',
    'LBL_CONFIG_FOOTER_ROWS_EMPTY_GRAND_TOTAL_3' => 'こちらにフィールドを追加していない場合、総計の行がビューから削除されます。',
