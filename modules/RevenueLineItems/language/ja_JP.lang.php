...
$mod_strings = array(
    ...
    'LBL_REVENUE_LINE_ITEMS_FOCUS_DRAWER_DASHBOARD' => '商品収益フォーカス ドロワ',
    ...
    'LBL_RENEWAL_RLI_NAME' => '商談品目総数の更新',
    'LBL_RENEWAL_RLI_ID' => '商談品目総数IDの更新',
    'LBL_PARENT_RLIS' => '親商談品目',
    'LBL_PARENT_RLIS_SUBPANEL_TITLE' => '親商談品目',
    'LBL_EXPERT_ID' => '製品エキスパート',
    'LBL_FORECAST' => '売上予測',
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => '予想額',
    'LBL_GENERATE_PURCHASE' => '購入の生成',
    'LBL_PURCHASED_LINE_ITEM' => '生成された購入商品',
    'LBL_PLI_NAME' => '生成された購入商品名',
    'LBL_PLI_ID' => '生成された購入商品ID',
    'LBL_ADD_ON_TO' => '以下に追加：',
    'LBL_ADD_ON_TO_ID' => 'IDに追加',
    'LBL_CONTACT' => '取引先担当者',
