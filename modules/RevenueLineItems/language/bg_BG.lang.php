...
$mod_strings = array(
    ...
    'LBL_REVENUE_LINE_ITEMS_FOCUS_DRAWER_DASHBOARD' => 'Чекмедже Фокус на позиции на приходи',
    ...
    'LBL_QUOTE_NAME' => 'Основна оферта:',
    'LBL_ASSOCIATED_QUOTE' => 'Основна оферта:',
    ...
    'LBL_RENEWAL_RLI_NAME' => 'Обновяване на приходна позиция',
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Изчислена сума',
    'LBL_GENERATE_PURCHASE' => 'Генериране на покупка',
    'LBL_PURCHASED_LINE_ITEM' => 'Генерирана закупена позиция',
    'LBL_PLI_NAME' => 'Име на генерирана закупена позиция',
    'LBL_PLI_ID' => 'Идентификатор на генерирана закупена позиция',
