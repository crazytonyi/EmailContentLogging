...
$mod_strings = array(
    ...
    'LBL_REVENUE_LINE_ITEMS_FOCUS_DRAWER_DASHBOARD' => 'Συρτάρι εστίασης στοιχείων γραμμής εσόδων',
    ...
    'LBL_QUOTE_NAME' => 'Βασική Προσφορά:',
    'LBL_ASSOCIATED_QUOTE' => 'Βασική Προσφορά:',
    ...
    'LBL_RENEWAL_RLI_NAME' => 'Ανανέωση Γραμμής Εσόδων',
    ...
    'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Υπολογισμένο ποσό',
    'LBL_GENERATE_PURCHASE' => 'Δημιουργία αγοράς',
    'LBL_PURCHASED_LINE_ITEM' => 'Παραγόμενη Γραμμή Στοιχείων που αγοράστηκαν',
    'LBL_PLI_NAME' => 'Όνομα Παραγόμενης Γραμμής Στοιχείων που αγοράστηκαν',
    'LBL_PLI_ID' => 'Ταυτότητα Παραγόμενης Γραμμής Στοιχείων που αγοράστηκαν',
