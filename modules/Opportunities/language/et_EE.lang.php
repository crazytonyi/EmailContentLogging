...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_START_DATE' => 'Teenuse alguskuupäev',
    ...
    'LBL_PARENT_RENEWAL_OPPORTUNITY_ID' => 'Uuenda ema ID-d',
    'LBL_MONTH_YEAR_RENEWAL' => '{{month}}, {{year}}',

    'LBL_WIDGET_SALES_STAGE' => 'Müügietapp',
    'LBL_WIDGET_DATE_CLOSED' => 'Eeldatav sulgemiskuupäev',
    ...
    'LBL_SERVICE_OPEN_FLEX_DURATION_RLIS' => '# avatud teenuse paindliku kestuse tulude rea üksustest',
    ...
    'LBL_UPDATE_OPPORTUNITIES_RLIS' => 'Värskendus avatud',
    'LBL_SERVICE_START_DATE_INVALID' => 'Ühegi avatud tulu reaüksuse lisandmooduli teenuse alguskuupäev ei tohi olla teenuse lõppkuupäevast hilisem.',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moodul {{plural_module_name}} võimaldab teil jälgida üksikuid müüke algusest lõpuni. Iga mooduli {{module_name}} kirje esindab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne. Moodul {{module_name}} läbib tavaliselt mitu müügietappi, kuni see märgitakse märksõnaga Suletud võit või Suletud kaotus. Moodulit {{plural_module_name}} on võimalik veelgi võimendada, kasutades Sugari moodulit {{forecasts_singular_module}}, et mõista ja prognoosida müügsuundumusi ning keskenduda töös müügikvootide täitmisele.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moodul {{plural_module_name}} võimaldab teil jälgida üksikuid müüke ja nende juurde kuuluvaid reaüksuseid algusest lõpuni. Iga mooduli {{module_name}} kirje esindab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne.
...
- Jälgige seda kirjet või lisage see lemmikute hulka, kasutades kirje nimest paremal asuvaid ikoone.
- Täiendavad toimingud on saadaval tegevuste rippmenüüs, mis asub nupust Redigeeri paremal.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Moodul {{plural_module_name}} võimaldab teil jälgida üksikuid müüke ja nende juurde kuuluvaid reaüksuseid algusest lõpuni. Iga mooduli {{module_name}} kirje esindab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne.

Mooduli {{module_name}} loomiseks tehke järgmist.
1. Esitage soovitud väljade väärtused.
 - Väljad märksõnaga Kohustuslik tuleb enne salvestamist ära täita.
 - Kui on vaja kuvada täiendavaid välju, klõpsake suvandit Kuva rohkem.
...
// END ENT/ULT
    ...
    'LBL_PIPELINE_ERR_CLOSED_SALES_STAGE' => 'Moodulit {{fieldName}} ei saa muuta kuna moodulil {{moduleSingular}} ei ole avatud reaüksuseid.',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Müügivõimaluse interaktsioonid',
);
