...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_OPEN_FLEX_DURATION_RLIS' => 'Número de elementos de ingresos de duración flexible de Open Service',
    ...
    'LBL_SERVICE_START_DATE_INVALID' => 'La fecha de inicio del servicio no puede ser posterior a la fecha de fin del servicio de cualquier línea de ingreso adicional abierta.',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales de principio a fin. Cada registro del {{module_name}} representa una venta potencial e incluye datos de venta relevantes, además de los relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} normalmente avanzará a través de numerosas Etapas de Ventas hasta que se marque como "Cerrado ganado" o "Cerrado perdido". {{plural_module_name}} se pueden aprovechar aún más con el módulo {{forecasts_singular_module}} de Sugar para entender y predecir las tendencias de ventas, así como para centrar el trabajo y conseguir los objetivos de ventas.',
...
- Vea o modifique enlaces a otros registros en los subpaneles cambiando el panel izquierdo inferior a "Ver datos".
- Comente o vea otros comentarios de usuarios y registrar el historial de cambios del registro {{activitystream_singular_module}} cambiando el panel izquierdo inferior a "Flujo de Actividades".
- Siga o haga favorito este registro mediante los iconos a la derecha del nombre del registro.
...
// END ENT/ULT
    ...
    'LBL_PIPELINE_ERR_CLOSED_SALES_STAGE' => 'No se ha podido cambiar el {{fieldName}} ya que este {{moduleSingular}} no tiene elementos de línea abiertos.',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Interacciones de oportunidades',
);
