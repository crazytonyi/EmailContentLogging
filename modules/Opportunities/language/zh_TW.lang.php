...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} 模組允許您從開始到結束的追蹤單個銷售。每個 {{module_name}} 紀錄代表一個潛在的銷售，包含相關的銷售數據以及與其他重要紀錄（如 {{quotes_module}}、{{contacts_module}} 等相關的銷售數據。{{module_name}} 通常會經歷幾個銷售階段，直到被標記為“談程結束”或“丟單結束”。{{plural_module_name}} 可以通過使用 Sugar 的 {{forecasts_singular_module}}ing 來理解和預測銷售趨勢，並集中精力完成銷售配額，從而進一步發揮作用。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模組允許您全程追蹤個人銷售和這些銷售的明細項目。每條 {{module_name}} 紀錄都代表一次預期銷售，包括相關銷售數據，且和 {{quotes_module}}、{{contacts_module}} 等其他重要記錄相關。

- 通過單擊單個字段或“編輯”按鈕來編輯此紀錄的字段。
- 通過切換左下角窗格至“數據視圖”來查看或修改子面板中其他紀錄的鏈結。
- 通過切換左下角窗格至“活動流”在 {{activitystream_singular_module}} 中撰寫和查看用戶評論和紀錄更改歷史。
- 使用紀錄名稱右側的圖標關注此紀錄或將此紀錄新增至收藏夾。
- “編輯”按鈕右側的下拉“操作”選單提供其他操作選項。',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模組允許您全程追蹤個人銷售和這些銷售的明細項目。每條 {{module_name}} 紀錄都代表一次預期銷售，包括相關銷售數據，且和 {{quotes_module}}、{{contacts_module}} 等其他重要記錄相關。

若要創建 {{module_name}}：
1. 按需提供字段值。
 - 標記為“必填”的字段在保存前必須先填寫完整。
 - 如有需要，單擊“顯示更多”以顯示其他字段。
2. 單擊“保存”以完成新紀錄，並返回至上一頁。',
