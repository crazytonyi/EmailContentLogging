...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modülü, bireysel satışları başından sonuna kadar izlemenizi sağlar. Her {{module_name}} kaydı, potansiyel bir satışı temsil eder ve {{quotes_module}}, {{contacts_module}} gibi ilgili satış verilerini ve diğer önemli kayıtlarla ilgili bilgileri içerir. Bir {{module_name}}, "Başarıyla Kapandı" veya "Başarısızlıkla Kapandı" olarak işaretlenene kadar genellikle birkaç Satış Aşaması boyunca ilerler. {{plural_module_name}}, satış eğilimlerini anlamak ve tahmin etmek ve satış kotalarını elde etmek için odaklanmayı belirlemek üzere Sugar&#39;ın {{forecasts_singular_module}} yapma modülünü kullanarak daha da geliştirilebilir.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} modülü, bireysel satışları ve bu satışlara ait kalemleri başından sonuna kadar izleminizi sağlar. Her {{module_name}} kaydı, potansiyel bir satışı temsil eder ve {{quotes_module}}, {{contacts_module}} gibi ilgili satış verilerini ve diğer önemli kayıtlarla ilgili bilgileri içerir.

- Bu kaydın alanlarını, herhangi bir alana veya "Değiştir" tuşuna tıklayarak değiştirin.
- Alt solda yer alan paneli "Veri Görünümü" olarak değiştirerek, alt panelde diğer kayıtlar ile olan bağlantıları görün veya değiştirin.
...
- Kayıt isminin sağındaki ikonları kullanarak kaydı izleyin veya favori olarak işaretleyin.
- Daha fazla aksiyon, Değiştir tuşunun sağındaki Aksiyonlar seçimli menüde yer almaktadır.',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} modülü, bireysel satışları ve bu satışlara ait kalemleri başından sonuna kadar izleminizi sağlar. Her {{module_name}} kaydı, potansiyel bir satışı temsil eder {{quotes_module}}, {{contacts_module}}, etc.
...
2. "Kaydet" tuşuna basarak yeni kaydı sona erdirin ve önceki sayfaya dönün.',
