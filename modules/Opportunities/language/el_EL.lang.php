...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Οι ενότητες {{plural_module_name}} σάς επιτρέπουν να παρακολουθείτε μεμονωμένες πωλήσεις και τα στοιχεία γραμμής που ανήκουν σε αυτές τις πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια ενδεχόμενη πώληση και περιλαμβάνει σχετικά δεδομένα πώλησης καθώς και σχετικά με άλλα σημαντικά αρχεία, όπως {{quotes_module}}, {{contacts_module}}, κ. λπ. Μία {{module_name}} συνήθως θα προχωρήσει μερικές φάσεις πωλήσεων έως ότου επισημανθεί είτε ως "Κλειστή κερδισμένή" είτε "Κλειστή χαμένη". Οι {{plural_module_name}} μπορεί να αξιοποιηθούν ακόμη περισσότερο χρησιμοποιώντας τη λειτουργική μονάδα {{forecasts_singular_module}} της Sugar για να κατανοήσετε και να προβλέψετε τις τάσεις πωλήσεων καθώς και για να εστιάσετε τις προσπάθειές σας στην επίτευξη των ποσοστώσεων πωλήσεων.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια ενδεχόμενη πώληση και περιλαμβάνει συναφή δεδομένα πώλησης καθώς και σχετικά με άλλα σημαντικά αρχεία, όπως {{quotes_module}}, {{contacts_module}}, κλπ. 

 - Επεξεργαστείτε τα πεδία αυτής της εγγραφής κάνοντας κλικ στο μεμονωμένο πεδίο ή στο κουμπί "Επεξεργασία". 
- Προβάλετε ή τροποποιήστε συνδέσεις με άλλες εγγραφές στους υπο-πίνακες, από την εναλλαγή του κάτω αριστερού παραθύρου σε "Προβολή Δεδομένων". 
- Αλληλεπιδράστε με τα σχόλια των χρηστών και την προβολή του ιστορικού αλλαγών στο {{activitystream_singular_module}} μέσω της εναλλαγής του κάτω αριστερού παραθύρου στο "Ροή Δραστηριοτήτων". 
- Ακολουθήστε ή σημειώστε ως αγαπημένες συγκεκριμένες εγγραφές χρησιμοποιώντας τα εικονίδια στα δεξιά του ονόματος της εγγραφής. 
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού Ενέργειες στα δεξιά του κουμπιού Επεξεργασία.',
...
2. Κάντε κλικ στο "Αποθήκευση" για να οριστικοποιήσετε την νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Αλληλεπιδράσεις ευκαιριών',
);
