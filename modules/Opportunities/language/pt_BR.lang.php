...
//END DON'T CONVERT
    ...
    'LBL_WIDGET_DATE_CLOSED' => 'Data prevista de fechamento',
    ...
    'LBL_UPDATE_OPPORTUNITIES_RLIS' => 'Atualização aberta',
    'LBL_SERVICE_START_DATE_INVALID' => 'A Data de início do serviço não pode ser posterior à Data de fim do serviço em Itens da linha de receita abertos.',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O módulo {{plural_module_name}} permite controlar as vendas individuais, do início ao fim. Cada registo de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registos importantes, como {{quotes_module}}, {{contacts_module}} etc. Um {{module_name}} normalmente progride por várias fases de vendas até ser marcado como "Ganho Fechado" ou "Perda Fechado". Os {{plural_module_name}} podem ser mais aproveitados com o uso do módulo {{forecasts_singular_module}} do Sugar para entender e prever as tendências de vendas, além de focar o trabalho para obter as quotas de vendas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'O módulo {{plural_module_name}} permite controlar as vendas individuais, do início ao fim. Cada registro de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc.
...
- Crie e visualize comentários de usuários e o histórico de alterações de registros no {{activitystream_singular_module}} alternando o painel esquerdo inferior para "Cadeia de Atividades".
...
- Ações adicionais estão disponíveis no menu suspenso Ações à direita do botão Editar.',
    ...
    'LBL_HELP_CREATE' => 'O módulo {{plural_module_name}} permite controlar as vendas individuais e os itens de linha pertencentes a essas vendas, do início ao fim. Cada registro de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como informações referentes a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc.
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Interações de oportunidade',
);
