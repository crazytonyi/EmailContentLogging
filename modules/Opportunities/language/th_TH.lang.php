...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายแต่ละรายการ และสินค้าในไลน์ที่เป็นของการขายเหล่านั้นตั้งแต่ต้นจนจบ ระเบียน {{module_name}} แต่ละอันอธิบายการขายที่คาดคะเนไว้ และข้อมูลการขายที่เกี่ยวข้องกัน รวมถึงระเบียนสำคัญอื่น ๆ ที่เกี่ยวข้อง เช่น {{quotes_module}} และ{{contacts_module}} เป็นต้น
...
- การดำเนินการเพิ่มเติมต่าง ๆ สามารถทำได้ในเมนู กระทำการ ซึ่งอยู่ในเมนูดรอปดาวน์ด้านขวาของปุ่มแก้ไข',
    ...
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการ และสินค้าในไลน์ที่เป็นของการขายเหล่านั้นตั้งแต่ต้นจนจบ แต่ละระเบียน{{module_name}} อธิบายการขายที่คาดคะเนไว้ และรวมถึงข้อมูลการขายที่เกี่ยวข้องกัน รวมถึงข้อมูลสำคัญอื่น ๆ ที่เกี่ยวข้อง เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น 
