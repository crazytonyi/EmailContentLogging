...
$mod_strings = array(
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Affärsmöjlighetsinformation',
    'LBL_OPPORTUNITIES_FOCUS_DRAWER_DASHBOARD' => 'Fokuslåda för möjligheter',
    'LBL_RENEWAL_OPPORTUNITY' => 'Förnyelsemöjlighet',
...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_START_DATE' => 'Startdatum för tjänst',
    ...
    'LBL_PURCHASED_LINE_ITEMS' => 'Köpta poster',

    'LBL_RENEWAL' => 'Förnyelse',
    'LBL_RENEWAL_OPPORTUNITIES' => 'Förnyelsemöjligheter',
    'LBL_RENEWAL_PARENT' => 'Huvudaffärsmöjlighet',
    'LBL_PARENT_RENEWAL_OPPORTUNITY_ID' => 'Förnya parent-ID',
    'LBL_MONTH_YEAR_RENEWAL' => '{{month}}, {{year}}',

    'LBL_WIDGET_SALES_STAGE' => 'Säljnivå',
    'LBL_WIDGET_DATE_CLOSED' => 'Förväntat slutdatum',
    'LBL_WIDGET_AMOUNT' => 'Mängd',
    ...
    'LBL_SERVICE_OPEN_FLEX_DURATION_RLIS' => '# av öppna intäktsposter med Service Flex-varaktighet',
    ...
    'LBL_UPDATE_OPPORTUNITIES_RLIS' => 'Uppdatering öppen',
    'LBL_SERVICE_START_DATE_INVALID' => 'Startdatum för tjänsten kan inte ställas in efter slutdatum för tjänsten för några öppna resultatradartiklar.',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}} gör det möjligt för dig att spåra enskilda försäljningar från start till mål. Varje {{module_name}}-post representerar en möjlig försäljning och inkluderar relevanta försäljningsdata och relaterar även till andra viktiga poster som {{quotes_module}}, {{contacts_module}}, osv. En {{module_name}} pågår vanligen under flera försäljningssteg innan den märks med antingen "Stängd vunnen" eller "Stängd förlorad". {{plural_module_name}} kan be förbättras ytterligare genom användning av Sugars modul {{forecasts_singular_module}} för att förstå och förutse försäljningstrender såväl som att fokusera arbetet på att uppnå försäljningskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulen {{plural_module_name}} gör det möjligt för dig att spåra individuella försäljningar och radartiklarna som hör till dessa försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning och inkluderar relevanta försäljningsdata så väl som att relatera till andra viktiga poster som {{quotes_module}}, {{contacts_module}}, osv.

- Redigera denna posts fält genom att klicka på ett individuellt fält eller på knappen Redigera.
- Se eller ändra länkar till andra poster i underpanelerna genom att växla rutan längst ner till vänster till "Datavisning".
- Skriv och se användarkommentarer och ändringshistorik för poster i {{activitystream_singular_module}} genom att växla rutan längst ner till vänster till "Aktivitetsflöde".
- Följ eller favoritmarkera denna post genom att använda ikonerna till höger om postnamnet.
- Ytterligare åtgärder finns tillgängliga i rullgardinsmenyn för åtgärder till höger om knappen Redigera.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} gör det möjligt för dig att spåra individuella försäljningar och radartiklar som hör till dessa försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning och inkluderar relevanta försäljningsdata så väl som att relatera till andra viktiga poster som {{quotes_module}}, {{contacts_module}}, osv.

För att skapa ett {{module_name}}:
1. Ange värden för fälten som önskas.
 - Fält som är markerade "Obligatoriskt" måste fyllas i innan du sparar.
 - Klicka på "Visa mer" för att visa fler fält om det behövs.
2. Klicka på "Spara" för att avsluta den nya posten och återvända till den föregående sidan.',
...
// END ENT/ULT
    ...
    'LBL_PIPELINE_ERR_CLOSED_SALES_STAGE' => 'Kunde inte ändra {{fieldName}} eftersom denna {{moduleSingular}} inte har några öppna linjeartiklar.',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Möjlighetsinteraktioner',
);
