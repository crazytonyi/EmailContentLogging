...
- Чтобы оставлять и просматривать пользовательские комментарии, а также изменять историю в рамках одной записи в {{activitystream_singular_module}}, переключите левую нижнюю панель в режим "Лента активности".
- Чтобы следить за этой записью или добавить ее в избранное, используйте значки справа от названия записи.
