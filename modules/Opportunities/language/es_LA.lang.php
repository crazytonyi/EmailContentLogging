...
$mod_strings = array(
    ...
    'LBL_OPPORTUNITIES_FOCUS_DRAWER_DASHBOARD' => 'Panel de Enfoque de Oportunidades',
...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_START_DATE' => 'Fecha de Inicio del Servicio',
    ...
    'LBL_PURCHASED_LINE_ITEMS' => 'Partidas individuales adquiridas',

    'LBL_RENEWAL' => 'Renovación',
    'LBL_RENEWAL_OPPORTUNITIES' => 'Oportunidades de renovación',
    'LBL_RENEWAL_PARENT' => 'Oportunidad de padre',
    'LBL_PARENT_RENEWAL_OPPORTUNITY_ID' => 'ID del padre de renovación',
    'LBL_MONTH_YEAR_RENEWAL' => '{{month}}, {{year}}',

    'LBL_WIDGET_SALES_STAGE' => 'Etapa de Venta',
    'LBL_WIDGET_DATE_CLOSED' => 'Fecha de Cierre Prevista',
    'LBL_WIDGET_AMOUNT' => 'Cantidad',
    ...
    'LBL_SERVICE_OPEN_FLEX_DURATION_RLIS' => '# de Partidas individuales de ingresos con duración flexible de Open Service',
    ...
    'LBL_UPDATE_OPPORTUNITIES_RLIS' => 'Actualización de Apertura',
    'LBL_SERVICE_START_DATE_INVALID' => 'La fecha de inicio del servicio no puede ser posterior a la fecha de finalización del servicio en ninguna partida individual de ingresos adicional abierta.',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El módulo {{plural_module_name}} le permite realizar seguimiento a ventas individuales desde principio a fin. Cada registro de {{module_name}} representa una venta potencial e incluye datos de venta relevantes, además de los relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} normalmente avanzará a través de numerosas Etapas de ventas hasta que se marque como "Cerrado ganado" o "Cerrado perdido". {{plural_module_name}} se puede aprovechar aún más con el módulo {{forecasts_singular_module}} de Sugar para entender y predecir las tendencias de ventas, así como para centrar el trabajo y conseguir cotizaciones de ventas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales y las partidas individuales pertenecientes a esas ventas de principio a fin. Cada registro del {{module_name}} representa una venta potencial e incluye datos de venta relevantes, además de los relacionados con otros registros importantes, como {{quotes_module}}, {{contacts_module}}, etc.

- Edite los campos de este registro haciendo clic en un campo individual o en el botón Editar.
- Vea o modifique vínculos a otros registros en los subpaneles cambiando el panel izquierdo inferior a "Vista de datos". 
- Comente o vea comentarios de usuarios y registre el historial de cambios en {{activitystream_singular_module}} cambiando el panel izquierdo inferior a "Flujo de actividades".
- Siga o convierta en favorito este registro mediante los iconos a la derecha del nombre del registro.
- Hay acciones adicionales disponibles en el menú desplegable Acciones a la derecha del botón Editar.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales y las partidas individuales pertenecientes a esas ventas de principio a fin. Cada registro del {{module_name}} representa una venta potencial e incluye datos de venta relevantes, además de los relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc.
...
// END ENT/ULT
    ...
    'LBL_PIPELINE_ERR_CLOSED_SALES_STAGE' => 'Imposible cambiar el {{fieldName}} ya que este {{moduleSingular}} no tiene partidas abiertas.',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Interacciones de oportunidad',
);
