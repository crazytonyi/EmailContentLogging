...
//END DON'T CONVERT
    ...
    'LBL_FILTER_OPPORTUNITY_TEMPLATE' => 'Prilike prema dinamičnom računu',
...
- Uredite polja ovog zapisa klikom na pojedinačno polje ili gumb Uredi. 
- Pregledajte ili izmijenite poveznice na ostale zapise u podpločama prebacivanjem donjeg lijevog okna na „Prikaz podataka”. 
- Objavljujte i pregledavajte komentare korisnika i bilježite povijest promjena u modulu {{activitystream_singular_module}} prebacivanjem donjeg lijevog okna na „Pregled aktivnosti”. 
...
Za izradu modula {{module_name}}:
1. Unesite vrijednosti polja po želji. 
 - Polja s oznakom „Obavezno” moraju se ispuniti prije spremanja.
 - Kliknite na „Prikaži više” da biste otkrili dodatna polja ako je potrebno.
2. Kliknite na „Spremi” da biste dovršili novi zapis i vratili se na prethodnu stranicu.',
