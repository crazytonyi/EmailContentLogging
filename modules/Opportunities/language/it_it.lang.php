...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Il modulo {{plural_module_name}} consente di monitorare le singole vendite dall&#39;inizio alla fine. Ogni record di {{module_name}} rappresenta una vendita potenziale e include dati di vendita pertinenti nonché relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}} e così via. Un {{module_name}} generalmente progredirà attraverso diverse fasi di vendita fino a quando non viene contrassegnato come "Chiuso vinto" o "Chiuso perso". {{plural_module_name}} può essere sfruttato ulteriormente utilizzando il modulo {{forecasts_singular_module}} di Sugar per comprendere e prevedere le tendenze di vendita e concentrare il lavoro per raggiungere le quote di vendita.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Il modulo {{plural_module_name}} consente di monitorare le singole vendite e i prodotti appartenenti a tali vendite dall&#39;inizio alla fine. Ogni record di {{module_name}} rappresenta una vendita potenziale e include dati di vendita pertinenti nonché relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}} e così via.

- Modificare i campi di questo record facendo clic su un singolo campo o sul pulsante Modifica.
- Visualizzare o modificare i collegamenti ad altri record nei sottopannelli spostando il riquadro in basso a sinistra su "Vista dati".
- Creare e visualizzare i commenti degli utenti e registrare la cronologia delle modifiche in {{activitystream_singular_module}} spostando il riquadro in basso a sinistra su "Flusso attività".
- Seguire o aggiungere ai preferiti questo record utilizzando le icone a destra del nome del record.
- Ulteriori azioni sono disponibili nel menu a discesa Azioni a destra del pulsante Modifica.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Il modulo {{plural_module_name}} permette di tenere traccia delle vendite individuali e dei prodotti che appartengono a quelle vendite dall&#39;inizio alla fine. Ciascun record di {{module_name}} rappresenta una vendita potenziale, comprende dati di vendita rilevanti e si relaziona con altri record importanti quali {{quotes_module}}, {{contacts_module}} ecc.
