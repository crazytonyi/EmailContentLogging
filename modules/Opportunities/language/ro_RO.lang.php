...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzări individuale de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} va parcurge de obicei câteva etape de vânzări până când va fi marcat „Încheiat cu succes” sau „Încheiat fără succes”. {{plural_module_name}} pot fi valorificate și mai mult folosind modulul {{forecasts_singular_module}} oferit de Sugar pentru a înțelege și pentru a estima tendințe de vânzări, precum și pentru a direcționa activitatea cu scopul de a atinge cotele de vânzări.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzări individuale și articolele aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}}, etc.

- Editați câmpurile acestei înregistrări făcând clic pe fiecare câmp individual sau pe butonul Editare. 
- Vizualizați sau modificați linkuri către alte înregistrări în panourile secundare, comutând fereastra din stânga jos în stadiul „Vizualizare date”. 
- Creați şi vizualizați comentariile altor utilizatori şi înregistrați istoricul modificărilor în {{activitystream_singular_module}} comutând fereastra din stânga jos în stadiul „Flux de activitate”. 
- Urmăriți sau marcați ca favorit această înregistrare folosind pictogramele din dreapta numelui înregistrării. 
- Sunt disponibile acţiuni suplimentare în meniul derulant Acţiuni din dreapta butonului Editare.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzări individuale și articolele aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}}, etc.
