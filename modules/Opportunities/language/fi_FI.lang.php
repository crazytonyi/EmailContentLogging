...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_START_DATE' => 'Palvelun aloituspäivä',
    ...
    'LBL_WIDGET_SALES_STAGE' => 'Myyntivaihe',
    'LBL_WIDGET_DATE_CLOSED' => 'Odotettu sulkupäivämäärä',
    'LBL_WIDGET_AMOUNT' => 'Määrä',
...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Moduulien {{plural_module_name}} avulla voi seurata yksittäisiä myyntejä ja myyntiin kuuluvia tuoterivejä alusta loppuun. Kukin {{module_name}} -tietue edustaa prospektiivista myyntiä ja sisältää tärkeitä myyntitietoja sekä muihin tärkeisiin tietueisiin, kuten {{quotes_module}}, {{contacts_module}} jne. liittyvää tietoa.
...
- Muita toimintoja löytyy Muokkaa-painikkeen oikealla puolella olevasta Toiminnot-alasvetovalikosta.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Moduulien {{plural_module_name}} avulla voit seurata yksittäisiä myyntejä ja niihin kuuluvia tuoterivejä alusta loppuun. Kukin {{module_name}} -tietue edustaa prospektiivista myyntiä ja sisältää siihen kuuluvat myyntitiedot sekä muihin tärkeisiin tietueisiin, kuten {{quotes_module}}, {{contacts_module}} jne., liittyvää tietoa. 

{{module_name}} -tietueen luominen: 
1. Syötä kentille arvoja. 
 - Pakollisiksi merkityt kentät on täytettävä ennen tallennusta. 
 - Saat esille lisää kenttiä tarvittaessa napsauttamalla &#39;Näytä lisää&#39;. 
2. Luo tietue napsauttamalla ‘Tallenna’. Tämän jälkeen palaat edelliselle sivulle.',
