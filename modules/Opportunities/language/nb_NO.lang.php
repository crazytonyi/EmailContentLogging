...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg fra start til slutt. Hvert {{module_name}}-register representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige registre som {{quotes_module}},{{contacts_module}}, osv. Et {{module_name}} vil typisk gå gjennom flere salgsfaser til det merkes enten "Lukket vunnet" eller "Lukket tapt". {{plural_module_name}} kan påvirkes ytterligere ved å bruke Sugars {{forecasts_singular_module}}-modul for å forstå og forutsi salgstrender så vel som fokusere arbeid for å oppnå salgskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjeposter som tilhører salgene fra start til slutt. Hvert {{module_name}} register representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige registre som {{quotes_module}}, {{contacts_module}}, osv.

- Rediger dette registerets felter ved å klikke på et individuelt felt eller Rediger-knappen.
- Vis eller endre lenker til andre registre i underpanelene inkludert ved å veksle nedre venstre rute til "Datavisning".
- Lag og vis brukerkommentarer og registrer endringshistorikk i {{activitystream_singular_module}} ved å bytte nedre venstre rute til "Aktivitetsstrøm".
- Følg eller gjør dette registeret til favoritt ved å bruke ikonene til høyre for registernavnet.
- Flere handlinger er tilgjengelige i nedtrekksmenyen Handlinger til høyre for Rediger-knappen.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjepostene som tilhører disse salgene fra start til slutt. Hver {{module_name}} post representerer et potensielt salg og inkluderer relevante salgsdata så vel som relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv.

For å opprette et {{module_name}}:
1. Oppgi verdier for feltene etter ønske.
 - Felt merket "Obligatorisk" må fullføres før lagring.
 - Klikk "Vis mer" for å vise ekstra felt om nødvendig.
2. Klikk "Lagre" for å sluttføre den nye posten og gå tilbake til den forrige siden.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Mulighetsinteraksjoner',
);
