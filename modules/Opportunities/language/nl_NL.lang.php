...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Met de module {{plural_module_name}} kunt u de individuele verkoop volgen van begin tot eind. Elke {{module_name}} record vertegenwoordigt een mogelijke verkoop en omvat verkoopgegevens en gegevens die betrekking hebben op andere belangrijke records, zoals {{quotes_module}}, {{contacts_module}}, etc. Een {{module_name}} doorloopt doorgaans meerdere verkoopfases, tot deze als "Gesloten, gewonnen" of "Gesloten, verloren" wordt gemarkeerd. {{plural_module_name}} kan verder worden ingezet door de module {{forecasts_singular_module}} van Sugar te gebruiken en verkooptrends te voorspellen of werk zo in te richten dat bepaalde verkoopquota&#39;s worden behaald.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Met de {{plural_module_name}} module kunt u van begin tot eind de individuele verkoop volgen. Elk {{module_name}} record vertegenwoordigt een mogelijke verkoop en omvat zowel relevante verkoopgegevens als gegevens die betrekking hebben op andere belangrijke records, zoals {{quotes_module}}, {{contacts_module}}, etc.

- Bewerk de velden van deze record door op een individueel veld te klikken of op de knop Bewerken.
- Bekijk of wijzig links naar andere records in de subpanelen door het paneel linksonderin op "Gegevensoverzicht" te zetten.
- Maak en bekijk opmerkingen en de veranderingsgeschiedenis van records in de {{activitystream_singular_module}} door het paneel linksonderin op "Activity Stream" te zetten.
- Volg deze record of maak er een favoriet van door de pictogrammen aan de rechterkant van de naam van de record te gebruiken.
- Er zijn meer handelingen beschikbaar via het vervolgkeuzemenu aan de rechterkant van de knop Bewerken.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'De {{plural_module_name}} module wordt gebruikt om individuele verkopen en de regelitems die daartoe behoren van begin tot eind te volgen en te beheren. Elke {{module_name}} vertegenwoordigt een mogelijke verkoop en omvat relevante verkoopgegevens, evenals andere belangrijke records zoals {{quotes_module}}, {{contacts_module}}, etc.
