...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduli {{plural_module_name}} mundëson gjurmimin e shitjeve individuale nga fillimi deri në fund. Çdo regjistrim {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes dhe ndërlidhet me regjistrime të tjera të rëndësishme, si {{quotes_module}}, {{contacts_module}} etj. Zakonisht, një {{module_name}} kalon në disa faza të shitjes derisa të shënohet si "Mbyllje me fitim" ose "Mbyllje me humbje". {{plural_module_name}} mund të përdoret edhe më tej duke përdorur modulin {{forecasts_singular_module}}ing të "Sugar" për të kuptuar dhe parashikuar tendencat e shitjeve, si dhe për t&#39;u përqendruar në arritjen e kuotave të shitjeve.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduli {{plural_module_name}} mundëson gjurmimin e shitjeve individuale dhe të artikujve të rreshtit që lidhen me ato shitje nga fillimi deri në fund. Çdo regjistrim {{module_name}} përbën një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes dhe ndërlidhet me regjistrime të tjera të rëndësishme, si {{quotes_module}}, {{contacts_module}} etj.

- Redakto fushat e këtij regjistrimi duke klikuar një fushë individuale ose butonin "Redakto".
- Shiko ose modifiko lidhjet me regjistrimet e tjera në nënpanele duke lëvizur panelin e poshtëm majtas te "Pamja e të dhënave"
...
- Ndiqe ose bëje të preferuar këtë regjistrim duke përdorur ikonat në të djathtë të emrit të regjistrimit.
- Veprime shtesë disponohen në menynë me zbritje të veprimeve që gjendet në të djathë të butonit "Redakto".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Moduli {{plural_module_name}} mundëson gjurmimin e shitjeve individuale dhe të artikujve të rreshtit që lidhen me ato shitje nga fillimi deri në fund. Çdo regjistrim i {{module_name}} përbën një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes dhe ndërlidhet me regjistrime të tjera të rëndësishme, si {{quotes_module}}, {{contacts_module}} etj.

Për të krijuar një {{module_name}}:
1. Jep vlerat për fushat sipas dëshirës.
 - Fushat me shënimin "E domosdoshme" duhet të plotësohen para se të ruhen.
 - Kliko "Shfaq më shumë" për të paraqitur fusha shtesë nëse është e nevojshme.
