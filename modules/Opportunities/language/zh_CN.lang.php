...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} 模块允许您从开始到结束跟踪单个销售。每个 {{module_name}} 记录代表一个潜在的销售，包括相关的销售数据以及与其他重要记录（如 {{quotes_module}}、{{contacts_module}} 等相关的销售数据。{{module_name}} 通常会经历几个销售阶段，直到被标记为“谈成结束”或“丢单结束”。{{plural_module_name}} 可以通过使用 Sugar 的 {{forecasts_singular_module}}ing 来理解和预测销售趋势，并集中精力完成销售配额，从而进一步发挥作用。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模块允许您全程追踪个人销售和这些销售的明细项目。每条 {{module_name}} 记录都代表一次预期销售，包括相关销售数据，且和 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关。
...
- “编辑”按钮右侧的下拉“操作”菜单提供其他操作选项。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模块允许您全程追踪个人销售和这些销售的明细项目。每条 {{module_name}} 记录都代表一次预期销售，包括相关销售数据，且和 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关。

若要创建 {{module_name}}：
1. 按需提供字段值。
 - 标记为“必填”的字段在保存前必须先填写完整。
 - 如有需要，单击“显示更多”以显示其他字段。
2. 单击“保存”以完成新记录，并返回至上一页。',
