...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O módulo {{plural_module_name}} permite-lhe controlar as vendas individuais, do início ao fim. Cada registo de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registos importantes, tais como {{quotes_module}}, {{contacts_module}}, etc. Um {{module_name}} normalmente progride por várias Fases de Vendas até ser marcado como "Ganho Fechado" ou "Perda Fechado". Os {{plural_module_name}} podem ser mais aproveitados com o uso do módulo {{forecasts_singular_module}} do Sugar para entender e prever as tendências de vendas, além de focar o trabalho para obter as quotas de vendas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'O módulo {{plural_module_name}} permite-lhe controlar as vendas individuais e os itens de linha referentes a essa vendas, do início ao fim. Cada registo de {{module_name}} representa uma possível venda e inclui dados de vendas relevantes, bem como referente a outros registos importantes, tais como {{quotes_module}}, {{contacts_module}}, etc.

-Edite os campos deste registo clicando num campo individualmente ou no botão Editar.
- Visualize ou modifique ligações para outros registos nos sub-painéis alternando o painel esquerdo inferior para "Visualização de Dados".
