...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}モジュールを使用すると、個々の売上を最初から最後まで追跡できます。各 {{module_name}} レコードは見込み販売を表し、関連する販売データや {{quotes_module}}、{{contacts_module}}などのその他の重要なレコードに関連しています。 {{module_name}} は通常、"Closed Won" または "Closed Lost"とマークされるまで、いくつかのセールスステージを進みます。{{plural_module_name}}は、売上傾向の理解と予測ならびに営業ノルマを達成するための集中作業のために、Sugarの {{forecasts_singular_module}}ing モジュールを使用することでさらに活用できます。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} モジュールを使用することで、個々の商談と、それらの商談に属している商品を開始から終了まで追跡できます。{{module_name}} の各レコードは見込みの売上を示しており、関連する売上データや、{{quotes_module}}、{{contacts_module}} などの重要な他のレコードに関連する売上データを含んでいます。
...
- 編集ボタンの右にあるドロップダウンアクションメニューで追加アクションを利用できます。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} モジュールを使用することで、個々の商談と、それらの商談に属している商品を開始から終了まで追跡できます。{{module_name}} の各レコードは見込みの売上を示しており、関連する売上データや、{{quotes_module}}、{{contacts_module}} などの重要な他のレコードに関連する売上データを含んでいます。
