...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות נפרדות מתחילת התהליך ועד סופו. כל רשומת {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתונים רלוונטיים לגבי המכירה ולגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכדומה. המודול {{module_name}} יתקדם בדרך כלל מספר שלבי מכירות עד שיסומן כ"נסגר בהצלחה" או "נסגר ואבד". ניתן למנף את המודול {{plural_module_name}} אפילו יותר באמצעות מודול {{forecasts_singular_module}} של Sugar כדי להבין ולחזות מגמות מכירה ולמקד את העבודה בהשגת מכסות המכירה.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות נפרדות - ואחר פריטי השורה ששייכים למכירות אלה - מתחילת התהליך ועד סופו. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתונים רלוונטיים לגבי המכירה ולגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכדומה.

- ערוך את שדות הרשומה על-ידי לחיצה על שדה מסוים או על הלחצן "עריכה".
- הצג או שנה קישורים לרשומות אחרות בתת-החלוניות על ידי שינוי מצב החלונית השמאלית התחתונה ל"תצוגת נתונים".
- צור והצג הערות משתמשים ותעד את היסטוריית השינויים ב-{{activitystream_singular_module}} על-ידי שינוי מצב החלונית השמאלית התחתונה ל"זרימת פעילות".
- עקוב אחר רשומה זו או סמן אותה כמועדפת באמצעות הסמלים שמימין לשמה.
- פעולות נוספות זמינות בתפריט הנפתח "פעולות" שמימין ללחצן "עריכה".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות נפרדות - ואחר פריטי השורה ששייכים למכירות אלה - מתחילת התהליך ועד סופו. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתונים רלוונטיים לגבי המכירה ולגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכדומה.

כדי ליצור {{module_name}}:
1. הזן ערכים בשדות כרצונך.
 - שדות המסומנים כשדות חובה חייבים לכלול ערך לפני שמתבצעת שמירה.
 - לחץ על "הצג עוד" כדי לחשוף שדות נוספים, לפי הצורך.
2. לחץ על "שמור" כדי להשלים את הרשומה החדשה ולחזור לעמוד הקודם.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'אינטראקציות לגבי הזדמנויות',
);
