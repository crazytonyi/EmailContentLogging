...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulet {{plural_module_name}} lader dig spore individuelle salg fra start til slut. Hvert {{module_name}} register repræsenterer et muligt salg og omfatter relevante salgsdata samt andre vigtige registre som {{quotes_module}}, {{contacts_module}} etc. Et {{module_name}} vil typisk gå igennem flere salgsstadier, før det markeres som enten "Lukket vundet" eller "Lukket tabt". {{plural_module_name}} kan udnyttes endnu mere ved at bruge Sugars modul {{forecasts_singular_module}} til at forstå og forudsige salgstrends samt fokusere arbejdet for at opnå de rette salgstal.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulet {{plural_module_name}} lader dig spore individuelle salg og linjeprodukter, der tilhører de salg, fra start til slut. Hvert {{module_name}} register repræsenterer et muligt salg og omfatter relevante salgsdata, samt relaterer til andre vigtige registre så som {{quotes_module}}, {{contacts_module}} etc.
...
- Lav og se brugerkommentarer, og registrér ændringshistorik i {{activitystream_singular_module}} ved at skifte den nederste venstre rude til "Aktivitetsstream".
- Følg eller favorisér dette register vha. ikonerne til højre for registerets navn.
- Yderligere handlinger er tilgængelige i rullegardinsmenuen Handlinger til højre for knappen Redigér.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulet {{plural_module_name}} lader dig spore individuelle salg og linjeprodukter, der tilhører disse salg, fra start til slut. Hvert {{module_name}} register repræsenterer et muligt salg og omfatter relevante salgsdata samt relaterer til andre vigtige registre så som {{quotes_module}}, {{contacts_module}} etc.

For at oprette et {{module_name}}:
1. Indsæt værdier for felterne.
 - Felter markeret "Påkrævet" skal udfyldes før gemning.
 - Klik på "Vis mere" for at vise yderligere felter om nødvendigt.
2. Klik på "Gem" for at afslutte det nye register og vende tilbage til den forrige side.',
