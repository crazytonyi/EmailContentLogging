...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} us permet fer un seguiment de les vendes individuals de principi a fi. Cada registre de {{module_name}} representa una possible venda i inclou les dades de venda corresponents, així com les relacionades amb altres registres importants, com ara {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} habitualment passa a través de diverses Etapes de Vendes fins que es marca com "Tancat guanyat" o "Tancat perdut". {{plural_module_name}} es poden aprofitar encara més si s&#39;utilitza el mòdul de {{forecasts_singular_module}} de Sugar per entendre i predir tendències de vendes, així com enfocar el treball per assolir les quotes de vendes.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El mòdul {{plural_module_name}} us permet fer un seguiment de vendes individuals i dels elements de línia que pertanyen a aquestes vendes de principi a fi. Cada registre de {{module_name}} representa una possible venda i inclou les dades de venda corresponents, a més d&#39;altres relacionades amb altres registres importants, com ara {{quotes_module}}, {{contacts_module}}, etc.

- Editeu els camps d&#39;aquest registre fent clic a un camp individual o al botó Edita.
- Visualitzeu o modifiqueu els enllaços a altres registres als subpanells canviant la subfinestra inferior esquerra a "Vista de dades".
- Feu i vegeu comentaris d&#39;altres usuaris i l&#39;historial de canvis del registre a {{activitystream_singular_module}} canviant la subfinestra inferior esquerra a "Seqüència d&#39;activitats". 
- Feu el seguiment d&#39;aquest registre o marqueu-lo com a preferit amb les icones que hi ha a la dreta del nom del registre. 
- Hi ha accions addicionals disponibles al menú desplegable Accions, a la dreta del botó Edita.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'El mòdul {{plural_module_name}} us permet fer un seguiment de les vendes individuals i dels elements de línia que pertanyen a aquestes vendes de principi a fi. Cada registre {{module_name}} representa una possible venda i inclou les dades de venda corresponents, a més d&#39;altres relacionades amb altres registres importants com ara {{quotes_module}}, {{contacts_module}}, etc.

Per crear un mòdul {{module_name}}:
1. Proporcioneu els valors desitjats per als camps.
 -Els camps marcats com "Obligatori" s&#39;han de completar abans de desar.
