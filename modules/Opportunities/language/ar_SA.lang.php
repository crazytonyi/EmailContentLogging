...
- اعرض الارتباطات إلى السجلات الأخرى أو عدلها في اللوحات الفرعية بتبديل الجزء الأيسر السفلي إلى "طريقة عرض البيانات".
- اصنع تعليقات المستخدمين واعرضها وسجل تاريخ التغييرات في {{activitystream_singular_module}} بتبديل الجزء السفلي الأيسر إلى "سير النشاط".
