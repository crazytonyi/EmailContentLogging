...
//END DON'T CONVERT
    ...
    'LBL_RENEWAL_PARENT' => 'Nadređena prodajna prilika',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} omogućuje praćenje pojedinačnih prodaja od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja potencijalnu prodaju i sadrži važne podatke o prodaji, kao i u vezi sa ostalim važnim zapisima kao što su moduli {{quotes_module}}, {{contacts_module}} itd. Modul {{module_name}} obično napreduje kroz nekoliko faza prodaje dok ne dobije oznaku „Zatvoreni dobitak” ili „Zatvoreni gubitak”. Modul {{plural_module_name}} može dodatno da se iskoristi korišćenjem Sugar modula {{forecasts_singular_module}} u svrhu razumevanja i predviđanja trendova prodaje, kao i usmeravanja posla prema postizanju prodajnih kvota.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} omogućuje praćenje pojedinačnih prodaja i stavki koje pripadaju tim prodajama od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja potencijalnu prodaju i sadrži važne podatke o prodaji, kao i u vezi sa ostalim važnim zapisima kao što su moduli {{quotes_module}}, {{contacts_module}} itd. 

- Uredite polja ovog zapisa klikom na pojedinačno polje ili dugme Uredi. 
- Pregledajte ili izmenite veze ka drugim zapisima u podtablama prebacivanjem donjeg levog okna na „Prikaz podataka”. 
- Objavljujte i pregledajte komentare korisnika i beležite istoriju izmena u modulu {{activitystream_singular_module}} prebacivanjem donjeg levog okna na „Tok aktivnosti”. 
- Pratite ili označite ovaj zapis kao omiljeni pomoću ikona koje se nalaze sa desne strane naziva zapisa. 
- Dodatne radnje su dostupne u padajućem meniju Radnje koji se nalazi sa desne strane dugmeta Uredi.',
...
1. Unesite vrednosti polja po želji. 
 - Polja s oznakom „Obavezno” moraju da se popune pre nego što ih sačuvate.
