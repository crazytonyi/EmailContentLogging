...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modulis leidžia jums stebėti individualų pardavimą nuo pradžios iki pabaigos. Kiekvienas {{module_name}} įrašas parodo numatomą pardavimą ir apima susijusius pardavimo duomenis bei susijusius su kitais svarbiais įrašais, tokiais kaip {{quotes_module}}, {{contacts_module}} ir kt. Paprastai {{module_name}} progresuos keliuose pardavimo etapuose, kol bus pažymėtas kaip „Uždarytas laimėtas“ arba „Uždarytas pralaimėjimas“. {{plural_module_name}} galima dar labiau panaudoti naudojant „Sugar“ {{forecasts_singular_module}}modulį, kad būtų galima suprasti ir numatyti pardavimo tendencijas, taip pat sutelkti dėmesį į pardavimo kvotas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Naudodami modulį {{plural_module_name}} galite nuo pradžios iki pabaigos sekti atskirą pardavimą ir jam priklausančias eilutės prekes. Kiekvienas {{module_name}} įrašas reiškia galimą pardavimą ir apima susijusius pardavimo duomenis, taip pat yra susijęs su kitais svarbiais įrašais, pvz., {{quotes_module}}, {{contacts_module}} ir kt.

− Redaguokite šio įrašo laukus spustelėdami atskirą lauką arba mygtuką „Redaguoti“.
− Peržiūrėkite arba modifikuokite nuorodas į kitus įrašus papildomuose skydeliuose, perjungdami apatinę kairiąją sritį į „Duomenų rodinys“.
...
− Mygtuko „Redaguoti“ dešinėje esančiame išplečiamajame meniu „Veiksmai“ rodomi galimi papildomi veiksmai.',
    ...
    'LBL_HELP_CREATE' => 'Naudodami modulį {{plural_module_name}} galite nuo pradžios iki pabaigos sekti atskirą pardavimą ir jam priklausančias eilutės prekes. Kiekvienas {{module_name}} įrašas reiškia galimą pardavimą ir apima susijusius pardavimo duomenis, taip pat yra susijęs su kitais svarbiais įrašais, pvz., {{quotes_module}}, {{contacts_module}} ir kt.

Norėdami sukurti {{module_name}}:
1. Nurodykite pageidaujamas laukų reikšmes.
 − Prieš įrašant reikia užpildyti laukus, pažymėtus kaip Privalomas.
 − Spustelėkite Rodyti daugiau, jei reikia parodyti papildomus laukus.
2. Spustelėkite Įrašyti, kad užbaigtumėte naują įrašą ir grįžtumėte į ankstesnį puslapį.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Galimybių sąveika',
);
