...
$mod_strings = array(
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Відомості про угоду',
    'LBL_OPPORTUNITIES_FOCUS_DRAWER_DASHBOARD' => 'Фокусна панель потенційних угод',
    'LBL_RENEWAL_OPPORTUNITY' => 'Поновлювальна угода',
...
//END DON'T CONVERT
    ...
    'LBL_SERVICE_START_DATE' => 'Дата початку обслуговування',
    ...
    'LBL_PURCHASED_LINE_ITEMS' => 'Куплені продукти',

    'LBL_RENEWAL' => 'Поновлення',
    'LBL_RENEWAL_OPPORTUNITIES' => 'Угоди, що поновлюються',
    'LBL_RENEWAL_PARENT' => 'Початкова угода',
    'LBL_PARENT_RENEWAL_OPPORTUNITY_ID' => 'ID початкової угоди, що поновлюється',
    'LBL_MONTH_YEAR_RENEWAL' => '{{month}}, {{year}}',

    'LBL_WIDGET_SALES_STAGE' => 'Стадія продажу',
    'LBL_WIDGET_DATE_CLOSED' => 'Очікувана дата закриття',
    ...
    'LBL_SERVICE_OPEN_FLEX_DURATION_RLIS' => '# позицій статті доходів із змінною тривалістю відкритого обслуговування',
    ...
    'LBL_UPDATE_OPPORTUNITIES_RLIS' => 'Відкрите оновлення',
    'LBL_SERVICE_START_DATE_INVALID' => 'Дата початку дії послуги має передувати даті закінчення дії послуги щодо будь-яких відкритих додаткових позицій доходів.',

    'LBL_QUOTE_SUBPANEL_TITLE' => 'Комерційні пропозиції',
    'LBL_FILTER_OPPORTUNITY_TEMPLATE' => 'Потенційні клієнти за динамічним обліковим записом',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. Модуль {{module_name}} зазвичай проходить кілька стадій продажу, доки не отримає статус "Виграно" або "Втрачено". Користь від застосування модуля {{plural_module_name}} можна збільшити, використовуючи модуль {{forecasts_singular_module}} системи Sugar для розуміння та прогнозування тенденцій продажів, а також для зосередження роботи на досягненні встановлених квот збуту.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що належать до них, від початку до кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.

- Щоб редагувати поля цього запису, натисніть окреме поле або кнопку "Редагувати".
- Щоб переглянути або змінити посилання на інші записи на субпанелях, перемкніть ліву нижню панель у режим "Перегляд даних".
- Щоб залишати та переглядати коментарі користувачів, а також змінювати історію в рамках одного запису в {{activitystream_singular_module}}, перемкніть ліву нижню панель у режим "Стрічка активності".
- Щоб стежити за цим записом або додати його до обраного, використовуйте піктограми праворуч від запису.
- Додаткові дії доступні в розкривному меню "Дії" праворуч від кнопки "Редагувати".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що належать до них, від початку до кінця. Кожен запис {{module_name}} потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.

Щоб створити {{module_name}}, виконайте наведені нижче дії.
1. Укажіть потрібні значення полів.
 - Перш ніж зберігати, заповніть поля з позначкою "Обов’язково".
...
// END ENT/ULT
    ...
    'LBL_PIPELINE_ERR_CLOSED_SALES_STAGE' => 'Не вдалося змінити {{fieldName}}, оскільки цей модуль {{moduleSingular}} не має відкритих позицій продуктів.',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Взаємодія з потенційним клієнтом',
);
