...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби от начало до край. Всеки запис {{module_name}} представя перспективна продажба и включва съответни данни за продажба, както и данни, свързани с други важни записи, като {{quotes_module}}, {{contacts_module}} и т.н. Един {{module_name}} обикновено ще премине през няколко етапа на продажба, докато не бъде отбелязан или като „Затворен спечелен" или „Затворен загубен". {{plural_module_name}} може дори да се използва по-нататък с помощта на модула {{forecasts_singular_module}} на Sugar, за да се разберат и предскажат тенденции в продажбите, както и да се фокусира работата за постигане на квоти на продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби и позиции от начало до край. Всеки запис {{module_name}} представя перспективна продажба и включва съответни данни за продажба, както и данни, свързани с други важни записи, като {{quotes_module}}, {{contacts_module}} и т. н.

- Редактирайте полетата на този запис като щракнете върху отделно поле или бутона „Редактирай".
- Разглеждайте или модифицирайте връзки към други записи в подпанелите чрез превключване на долния ляв панел към „Изглед на данни".
- Правете и разглеждайте потребителски коментари и записвайте хронологията на промените в {{activitystream_singular_module}} рез превключване на долния ляв панел към „Поток на активности".
- Следвайте или предпочитайте този запис с помощта на иконите отдясно на името на записа.
- Допълнителни действия са налични в падащото меню „Действия" отдясно на бутона „Редактирай".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби и позициите, принадлежащи към тези продажби, от начало до край. Всеки запис {{module_name}} представя перспективна продажба и включва съответни данни за продажба, както и данни, свързани с други важни записи, като {{quotes_module}}, {{contacts_module}} и т. н.

За създаване на {{module_name}}:
1. Дайте стойности за полетата според желанието.
 - Полетата, отбелязани като „Задължителни", трябва да бъдат попълнени преди записване.
 - Щракнете върху „Покажи още", за да се изведат допълнителни полета, ако е необходимо.
2. Щракнете върху „Запис", за да финализирате новия запис и да се върнете към предишната страница. Полетата, отбелязани като „Задължителни", трябва да бъдат попълнени преди записване.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Взаимодействия на възможност',
);
