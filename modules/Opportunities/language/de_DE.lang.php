...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potenziellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch einen Bezug auf andere wichtige Datensätze, wie z. B. {{quotes_module}}, {{contacts_module}} usw. Ein {{module_name}} wird normalerweise mehrere Verkaufsphasen durchlaufen, bis entweder „Geschlossen gewonnen" oder „Geschlossen verloren" markiert wird. Der {{plural_module_name}} kann noch weiter genutzt werden, indem Sie das Modul {{forecasts_singular_module}} von Sugar verwenden, um Verkaufstrends zu verstehen und vorherzusagen sowie auch, um die Arbeit darauf zu konzentrieren, Verkaufsquoten zu erreichen.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe samt dazugehöriger Produkte von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potenziellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch einen Bezug auf andere wichtige Datensätze, wie z. B. {{quotes_module}}, {{contacts_module}} usw. 

- Bearbeiten Sie den Datensatz, indem Sie auf ein einzelnes Feld oder auf die Schaltfläche „Bearbeiten" klicken. 
- Zeigen Sie Links zu anderen Datensätzen in den Sub-Panels an bzw. ändern Sie diese, indem Sie den linken unteren Bereich auf „Datenansicht" stellen". 
- Erstellen Sie Benutzerkommentare oder zeigen Sie diese an oder zeichnen Sie die Änderungshistorie verschiedener Datensätze im {{activitystream_singular_module}} auf, indem Sie die Ansicht auf „Aktivitäts-Stream" im unteren linken Bereich stellen. 
- Folgen Sie diesem Datensatz oder markieren Sie ihn als Favorit, indem Sie auf die Symbole rechts neben dem Namen des Datensatzes klicken. 
- Weitere Aktionen finden Sie im Dropdown-Menü rechts neben der Schaltfläche „Bearbeiten".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe samt dazugehöriger Produkte von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potenziellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch den Bezug auf andere wichtige Datensätze, wie z. B. {{quotes_module}}, {{contacts_module}} usw.
