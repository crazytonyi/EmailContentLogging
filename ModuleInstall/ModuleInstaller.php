 ...
 */
    ...
    public static function getPortalConfig()
    {
        ...
        $portalConfig = array(
            ...
            'serverUrl' => $config->get('site_url') . '/rest/v11_11',
    ...
    /**
     * Uninstalls specific dashboards. User-created dashboards are untouched.
    ...
    protected function uninstall_dashboards()
    {
        ...
        if (empty($this->installdefs['beans']) || empty($dashboardsToRemove)) {
            return;
        }
        ...
        $query->where()->queryAnd()
            ->in('view_name', $dashboardsToRemove)
            ->in('dashboard_module', $modules);
        $data = $query->execute();
