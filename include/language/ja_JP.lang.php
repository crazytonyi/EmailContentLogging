...
"5. アプリケーションでアクションメニューのインポートオプションをクリックしてアップロードするファイルを選択します"   ',
    ...
    'LBL_CSP_ERROR_MESSAGE' => '入力した値はサポートされていないか、許容される形式を満たしていません。 受け入れ可能なフィールド値とフォーマットのリストについては、<a href={{linkToDocumentation}} target="_blank">システム</a> ドキュメントを参照してください。',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'このコンテンツは承認されていません。 システムのコンテンツセキュリティポリシー設定を更新してください。',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'このコンテンツは承認されていません。ご利用のシステムのコンテンツセキュリティポリシー設定を更新するには、管理者に問い合わせてください。',
...
代わりに、既存のレコードの値ではなく今入力した値を使用する場合は、[元にリセット] をクリックします。入力した値は既存のレコードに適用され、さらに追加の変更を加え、既存のレコードへの変更を確定する[保存] をクリックします。入力した値を使用して新しいレコードを作成するには、画面右上の[重複を無視して保存」をクリックします。',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => '通信',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => '{{moduleSingular}} 通信',
