...
「5. 在應用程式的動作菜單中按一下「匯入」選項，並選取文件上載」   ',
    ...
    'LBL_CSP_ERROR_MESSAGE' => '您輸入的值不受支援或不是可接受的格式。如需獲取可接受字段值和格式的列表，請參閱<a href={{linkToDocumentation}} target="_blank">系統</a>文件',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => '此內容未受批准。請更新系統的內容安全政策設定。',
    'LBL_CSP_ERROR_MESSAGE_USER' => '此內容未受批准。請要求管理員更新系統的內容安全政策設定。',
