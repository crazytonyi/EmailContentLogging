...
$app_strings = array (
  ...
  'ERR_FILE_NOT_FOUND' => 'Hata: {0} dosyası yüklenemiyor. Lütfen sistem ve web sunucusu izinleri kontrol ediniz.',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Girmiş olduğunuz değer(ler), desteklenmiyor veya kabul edilebilir biçimi karşılamıyor. Kabul edilebilir alan değerleri ve biçimlerinin bir listesi için <a href={{linkToDocumentation}} target="_blank">Sistem</a> belgesine bakın',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Bu içerik onaylanmadı. Lütfen sisteminizin İçerik Güvenliği Politikası Ayarlarını güncelleyin.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Bu içerik onaylanmadı. Yöneticinizden sisteminizin İçerik Güvenliği Politikası Ayarlarını güncellemesini isteyin.',
