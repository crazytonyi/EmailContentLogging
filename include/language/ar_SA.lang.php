...
"5. انقر فوق خيار استيراد من القائمة "إجراءات" في التطبيق واختر الملف المراد تحميله"
   ',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'القيمة (القيم) التي أدخلتها غير مدعومة أو ليست بتنسيق مقبول. لقائمة من قيم وتنسيقات الحقول المقبولة، ارجع إلى وثائق <a href={{linkToDocumentation}} target="_blank">النظام</a>',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'لم تتم الموافقة على هذا المحتوى. الرجاء تحديث إعدادات سياسة أمان المحتوى للنظام.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'لم تتم الموافقة على هذا المحتوى. اطلب من مسؤولك تحديث إعدادات سياسة أمان المحتوى للنظام.',
