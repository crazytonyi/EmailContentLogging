...
$app_strings = array (
 ...
 Vänligen ändra värdena.",
  ...
  'ERR_FILE_NOT_FOUND' => 'Fel: Kunde inte ladda file {0}. Vänligen kolla system och webserver behörigheter',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Värdet(-ena) som du har angett stöds inte eller lever inte upp till acceptabelt format. För en lista över acceptabla fältvärden och format, se <a href={{linkToDocumentation}} target="_blank">Systemdokumentation</a>',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Detta innehåll har inte godkänts. Uppdatera inställningarna för ditt systems innehållssäkerhetspolicy.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Detta innehåll har inte godkänts. Be din administratör att uppdatera inställningarna för ditt systems innehållssäkerhetspolicy.',
