...
$app_strings = array (
  ...
  'ERR_FILE_NOT_FOUND' => 'Virhe: Ei voitu avata tiedostoa {0}. Tarkista järjestelmän ja palvelimen käyttöoikeudet.',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Antamaasi arvoa ei tueta tai se ei ole oikeanlaisessa muodossa. Luettelo hyväksytyistä kentän arvoista ja muodoista löytyy <a href={{linkToDocumentation}} target="_blank">Järjestelmä</a>-ohjeista',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Sisältöä ei ole hyväksytty. Päivitä järjestelmän sisällön turvallisuuskäytäntöjen asetukset.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Sisältöä ei ole hyväksytty. Pyydä järjestelmänvalvojaa päivittämään järjestelmän sisällön turvallisuuskäytäntöjen asetukset.',
