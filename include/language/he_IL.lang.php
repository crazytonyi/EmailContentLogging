...
$app_strings = array (
  ...
  'ERR_FILE_NOT_FOUND' => 'שגיאה: לא מצליח לטעון קובץ {0}.  בדוק הרשאות בשרת שלך.',
    ...
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'תוכן זה לא אושר. עדכן את ההגדרות של מדיניות אבטחת תוכן במערכת.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'תוכן זה לא אושר. בקש ממנהל המערכת לעדכן את ההגדרות של מדיניות אבטחת תוכן במערכת.',
...
כדי ליצור רישום חדש בעזרת הערכים שהזנת, לחץ על "התעלם מכפילות ושמור" בחלק הימני-עליון של המסך.',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => 'אינטראקציות',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'אינטראקציות {{moduleSingular}}',
