...
SugarCRM',
  ...
  'ERR_FILE_NOT_FOUND' => 'Feil: Kunne ikke laste opp filen {0}. Vennligst sjekk system-og web server tillatelser.',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Verdien(e) du har oppgitt støttes ikke eller oppfyller ikke det akseptable formatet. For en liste over akseptable feltverdier og formater, se <a href={{linkToDocumentation}} target="_blank">System</a> -dokumentasjone',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Dette innholdet har ikke blitt godkjent. Oppdater systemets retningslinjeinnstillinger for innholdssikkerhet.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Dette innholdet har ikke blitt godkjent. Be administratoren om å oppdatere systemets retningslinjeinnstillinger for innholdssikkerhet.',
...
2. Klikk "Lagre" for å sluttføre den nye posten og gå tilbake til {{plural_module_name}}: listevisning.',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => 'Interaksjoner',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => '{{moduleSingular}} interaksjoner',
