...
" 5. Haga clic en la opción Importar en el menú Acciones en la aplicación y elegir el archivo que desea cargar"   ',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'El o los valores que ingresó no se admiten o no cumplen con el formato aceptado. Para obtener una lista de valores y formatos de campos aceptados, consulte la documentación de <a href={{linkToDocumentation}} target="_blank">Sistema</a>',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Este contenido no se aprobó. Actualice la configuración de Directiva de seguridad de contenido de su sistema.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Este contenido no se aprobó. Pida a su administrador que actualice la configuración de Directiva de seguridad de contenido de su sistema.',
...
Para crear un nuevo registro utilizando los valores que ha introducido, haga clic en "Ignorar Duplicados y Guardar" en la parte superior derecha de la pantalla.',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => 'Interacciones',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Interacciones de {{moduleSingular}}',
