    ...
    app.events.on('app:init', function() {
        app.plugins.register('FocusDrawer', ['field'], {
            ...
            checkFocusAvailability: function() {
                ...
                return focusDrawerIsEnabled && userHasValidFocusLicense &&
                    fieldIsValid && moduleIsValid && focusDrawerComponentExists;
            },
            ...
            /**
             * Search up the chain of layouts to find the focus drawer component
