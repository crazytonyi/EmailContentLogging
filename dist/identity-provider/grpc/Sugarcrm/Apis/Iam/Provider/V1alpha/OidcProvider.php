...
/**
 * Generated from protobuf message <code>sugarcrm.apis.iam.provider.v1alpha.OidcProvider</code>
 */
class OidcProvider extends \Google\Protobuf\Internal\Message
{
    /**
     * srn:cloud:idp::1234567890:provider:oidc
     *
     ...
     * OIDC Configuration
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.OidcConfig config = 2;</code>
     */
    private $config = null;
    /**
     * Attribute mappings
     ...
     *     @type string $name
     *           srn:cloud:idp::1234567890:provider:oidc
     *     @type \Sugarcrm\Apis\Iam\Provider\V1alpha\OidcConfig $config
     *           OIDC Configuration
     ...
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.OidcConfig config = 2;</code>
     * @return \Sugarcrm\Apis\Iam\Provider\V1alpha\OidcConfig
     */
     ...
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.OidcConfig config = 2;</code>
     * @param \Sugarcrm\Apis\Iam\Provider\V1alpha\OidcConfig $var
     * @return $this
     */
    public function setConfig($var)
    {
        GPBUtil::checkMessage($var, \Sugarcrm\Apis\Iam\Provider\V1alpha\OidcConfig::class);
        $this->config = $var;
