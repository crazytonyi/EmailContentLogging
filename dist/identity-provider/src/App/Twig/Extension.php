...
class Extension extends AbstractExtension implements GlobalsInterface
{
    ...
    public function getGlobals()
    {
        ...
        if ($tenant) {
            ...
            $languages = $metadataService->getLanguages($tenant);
            if ($languages) {
                $locales = array_intersect_key($locales, $languages);
            }
        }
        ...
        return [
            ...
            'locales' => $locales,
            'marketingExtrasApi' => $this->app->getUrlGeneratorService()->generate(
                'getMarketingContentUrl',
                ['tid' => $tenant ?? $_COOKIE['tid']]
            ),
        ];
    }
