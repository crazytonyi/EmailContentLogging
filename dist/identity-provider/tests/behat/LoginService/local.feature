...
Feature: Login
  ...
  User should see password rules on set password page
  ...
  User should see password rules on the Change Password page

  Scenario: Existing user tries to login and logout
    Given I am on "/"
    And I login as "sally" with password "sally" to tenant "2000000008"
    Then I should see "You are logged in as sally"
    Then I should see "Your tenant id is srn:cloud:iam:eu:2000000008:tenant"
    Then I should see "Authentication provider - Local"
    And I should see logo with "alt" = "Local, LDAP Test Tenant for Login Service"
    ...
    And the "tenant_hint" field should contain "2000000008"
  ...
  Scenario: User doesn't see tenant if it's pre-filled
    Given I am on "/?tenant_hint=srn:cloud:iam:eu:2000000008:tenant"
    Then I wait for the element "input[name=user_name]"
    Then I should not see "Tenant ID"
  ...
  Scenario: User sees an error in case of inactive tenant hint
    Given I am on "/?tenant_hint=2000000007"
    Then I should see a "#tenant_hint" element
    And I should see "Tenant isn't active"

  Scenario: User opens forgot password form
    Given I am on "/password/forgot?tid=2000000008"
  ...
  Scenario: User should see password rules on set password page
    Given I am on "/password/set/?tid=2000000008&token=validToken"
    And I wait for the element "input[name=newPassword]"
    Then I should see "Reset your password"
    And I should see logo with "alt" = "Local, LDAP Test Tenant for Login Service"
    And I should see logo with "src" = "data:image/png;base64,"
    And I should see "Minimum length = 6"
    And I should see "Must contain one upper case letter (A-Z)"
    And I should see "Must contain one lower case letter (a-z)"
    And I should see "Must contain one number (0-9)"
    And I should see "Must contain one special character (~!@#$%^&*()_+-={}|)"
  ...
  Scenario: User should see password rules on the Change Password page
    Given I am on "/"
    And I login as "sally" with password "sally" to tenant "2000000008"
    Then I should see "You are logged in as sally"
    Given I am on "/password/change"
    And I wait for the element "input[type=password]"
    Then I should see "Minimum length = 6"
    Then I should see "Must contain one upper case letter (A-Z)"
    Then I should see "Must contain one lower case letter (a-z)"
    Then I should see "Must contain one number (0-9)"
    Then I should see "Must contain one special character (~!@#$%^&*()_+-={}|)"
    Given I am on "/"
    Then I do logout
