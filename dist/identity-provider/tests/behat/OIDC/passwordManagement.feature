...
Feature: Password Management
  ...
  Scenario: Verify Password Management page in SugarCRM
    ...
    Then I should see "Password Management is only available in SugarCloud Settings"
    And I logout
  ...
  Scenario: Verify Password Management link in SugarCRM
    ...
    Then The document should open in a new tab with url "http://console.sugarcrm.local/password-management?tenant_hint=srn%3Acloud%3Aiam%3Aeu%3A2000000001%3Atenant&user_hint=srn%3Acloud%3Aiam%3A%3A2000000001%3Auser%3A1"
    And I logout
