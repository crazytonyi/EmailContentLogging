...
$sugar_config['SAML_SAME_WINDOW'] = true;
...
$sugar_config['SAML_issuer'] = 'samlSameWindowRedirectNoUserProvision';
$sugar_config['SAML']['strict'] = true;
$sugar_config['site_url'] = 'http://behat-tests-mango-saml-same-window-no-user-provision';
