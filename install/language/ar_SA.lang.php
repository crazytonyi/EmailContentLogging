...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'لم يتم العثور عليه: ستعمل أداة جدولة Sugar بوظائف محدودة. لن تعمل خدمة أرشفة البريد الإلكتروني.',
    ...
    'ERR_CHECKSYS_FASTCGI'              => 'اكتشفنا أنك لا تستخدم خريطة معالج FastCGI لـ PHP. ستحتاج إلى تثبيت/تكوين إصدار متوافق مع تطبيق Sugar.  يُرجى الرجوع إلى مصفوفة التوافق في ملاحظات الإصدار لمعرفة الإصدارات المدعومة. يُرجى مراجعة <a href="http://www.iis.net/php/" target="_blank" rel="nofollow noopener noreferrer">http://www.iis.net/php/</a> لمزيد من التفاصيل ',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على دعم قاعدة البيانات. الرجاء التأكد من أنك تملك برامج التشغيل اللازمة لأحد أنواع قواعد البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء ربط الامتداد في ملف php.ini أو إعادة التكوين باستخدام الملف الثنائي الصحيح، وذلك حسب إصدار PHP لديك. الرجاء الرجوع إلى دليل PHP لمزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
...
<li>/تحميل</b></li></ul></li></ul>
    ...
    'meeting_notification_email' => array(
        'name' => 'بريد إلكتروني بإشعارات الاجتماعات',
        'subject' => 'اجتماع SugarCRM - $event_name ',
        'description' => 'يُستخدم هذا القالب عند إرسال النظام إشعارات اجتماعات إلى مستخدم.',
        'body' => '<div>
	<p>إلى: $assigned_user</p>

	<p>$assigned_by_user دعاك إلى اجتماع</p>

	<p>الموضوع: $event_name<br/>
	تاريخ البدء: $start_date<br/>
	تاريخ الانتهاء: $end_date</p>

	<p>الوصف: $description</p>

	<p>قبول هذا الاجتماع:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>قبول هذا الاجتماع مبدئيًا:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>رفض هذا الاجتماع:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'إلى: $assigned_user

$assigned_by_user دعاك إلى اجتماع
...
<$decline_link>',
    ...
    'call_notification_email' => array(
        'name' => 'بريد إلكتروني بإشعارات المكالمات',
        'subject' => 'مكالمة SugarCRM - $event_name ',
        'description' => 'يُستخدم هذا القالب عند إرسال النظام إشعارات مكالمات إلى مستخدم.',
        'body' => '<div>
	<p>إلى: $assigned_user</p>

	<p>$assigned_by_user دعاك إلى اتصال</p>

	<p>الموضوع: $event_name<br/>
	تاريخ البدء: $start_date<br/>
	المدة: $hoursh, $minutesm</p>

	<p>الوصف: $description</p>

	<p>قبول هذا الاتصال:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>قبول هذا الاتصال مبدئيًا:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>رفض هذا الاتصال:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'إلى: $assigned_user

$assigned_by_user دعاك إلى اتصال

الموضوع: $event_name
تاريخ البدء: $start_date
المدة: $hoursh, $minutesm
...
مرفق هنا تقرير منشأ تلقائيًا كان قد تم جدولته لك.

اسم التقرير: $report_name

تاريخ ووقت تشغيل التقرير: $report_time',
    ),

    'comment_log_mention_email' => [
        'name' => 'إشعار بالبريد الإلكتروني لسجل تعليقات النظام',
        'subject' => 'SugarCRM - $initiator_full_name أشار إليك في (n) $singular_module_name',
        'description' => 'يُستخدم هذا القالب لإرسال إشعار بالبريد الإلكتروني للمستخدمين الذي تم تحديدهم في قسم سجل التعليقات.',
        'body' =>
            '<div>
                <p>تمت الإشارة إليك في سجل تعليقات السجل التالي:  <a href="$record_url">$record_name</a></p>
                <p>الرجاء تسجيل الدخول إلى Sugar لعرض التعليق.</p>
            </div>',
        'txt_body' =>
'تمت الإشارة إليك في سجل تعليقات السجل التالي: $record_name
...
'portal_forgot_password_email_link' => [
    'name' => 'البريد الإلكتروني عند نسيان كلمة مرور المدخل',
    'subject' => 'إعادة تعيين كلمة مرور الحساب',
    'description' => 'يُستخدم هذا القالب لإرسال ارتباط إلى المستخدم للنقر فوقه لإعادة تعيين كلمة مرور حساب مستخدم المدخل.',
    'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>لقد طلبت حديثًا إعادة تعيين كلمة مرور الحساب. </p><p>انقر على الارتباط أدناه لإعادة تعيين كلمة المرور:</p><p> <a href="$portal_user_link_guid">$portal_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
    'txt_body' =>
'
    لقد طلبت مؤخرًا إعادة تعيين كلمة المرور الخاصة بحسابك.

    انقر فوق الارتباط أدناه لإعادة تعيين كلمة المرور الخاصة بك:

    $portal_user_link_guid',
],

    'portal_password_reset_confirmation_email' => [
        'name' => 'رسالة تأكيد إعادة تعيين كلمة مرور المدخل',
        'subject' => 'أُعيد تعيين كلمة مرور الحساب',
        'description' => 'يستخدم هذا القالب لإرسال تأكيد إلى مستخدم مدخل تمت إعادة تعيين كلمة مرور حسابه.',
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>هذه الرسالة لتأكيد إعادة تعيين كلمة مرور حساب المدخل. </p><p>استخدم الارتباط أدناه لتسجيل الدخول إلى المدخل:</p><p> <a href="$portal_login_url">$portal_login_url</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
    هذه الرسالة لتأكيد أنه تمت إعادة تعيين كلمة مرور حساب المدخل.

    استخدم الارتباط أدناه لتسجيل الدخول إلى المدخل:
