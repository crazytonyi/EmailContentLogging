...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_FASTCGI'              => 'Sie benutzen kein FastCGI Handler Mapping für PHP. Bitte installieren oder konfigurieren Sie eine Version, die mit der Sugar-Anwendung kompatibel ist. Konsultieren Sie die Kompatibilitätsmatrix in den Versionshinweisen, um mehr über unterstützte Versionen zu erfahren. Weitere Informationen finden Sie unter <a href="http://www.iis.net/php/" target="_blank" rel="nofollow noopener noreferrer">http://www.iis.net/php/</a>. ',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Keine Datenbankunterstützung gefunden. Stellen Sie sicher, dass Sie die notwendigen Treiber für einen der folgenden, unterstützten Datenbanktypen besitzen: MySQL, MS SQLServer, Oracle oder DB2. Sie müssen je nach Ihrer PHP-Version eventuell die Kommentierung der Erweiterung in der Datei \'php.ini\' aufheben oder die richtige binäre Datei neu kompilieren. Weitere Informationen zum Aktivieren der Datenbankunterstützung finden Sie in Ihrem PHP-Handbuch.',
...
Nehmen Sie die erforderlichen Änderungen vor, und führen Sie die System-Überprüfung daraufhin erneut durch, um mit der Installation fortzufahren.<br>',
    ...
    'meeting_notification_email' => array(
        'name' => 'Benachrichtigungs-E-Mails über Meetings',
        'subject' => 'SugarCRM-Meeting - $event_name ',
        'description' => 'Diese Vorlage wird verwendet, wenn das System Benachrichtigungen über Meetings an einen Benutzer sendet.',
        'body' => '<div>
	<p>To: $assigned_user</p>

	<p>$assigned_by_user hat Sie zu einem Meeting eingeladen</p>

	<p>Betreff: $event_name<br/>
	Startdatum: $start_date<br/>
	Enddatum: $end_date</p>

	<p>Beschreibung: $description</p>

	<p>Diesem Meeting zusagen:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>Diesem Meeting unter Vorbehalt zusagen:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>Diesem Meeting absagen:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'To: $assigned_user

$assigned_by_user hat Sie zu einem Meeting eingeladen
...
Diesem Meeting zusagen:
<$accept_link>

Diesem Meeting unter Vorbehalt zusagen
<$tentative_link>

Diesem Meeting absagen
<$decline_link>',
    ),

    'call_notification_email' => array(
        'name' => 'Benachrichtigungs-E-Mails über Anrufe',
        'subject' => 'SugarCRM-Anruf - $event_name ',
        'description' => 'Diese Vorlage wird verwendet, wenn das System Benachrichtigungen über Anrufe an einen Benutzer sendet.',
        'body' => '<div>
	<p>To: $assigned_user</p>

	<p>$assigned_by_user hat Sie zu einem Anruf eingeladen</p>

	<p>Betreff: $event_name<br/>
	Startdatum: $start_date<br/>
	Dauer: $hoursh, $minutesm</p>

	<p>Beschreibung: $description</p>

	<p>Diesem Anruf zusagen:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>Diesem Anruf unter Vorbehalt zusagen:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>Diesem Anruf absagen:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'To: $assigned_user

$assigned_by_user hat Sie zu einem Anruf eingeladen

Betreff: $event_name
Startdatum: $start_date
Dauer: $hoursh, $minutesm

Beschreibung: $description

Diesem Anruf zusagen:
<$accept_link>

Diesem Anruf unter Vorbehalt zusagen
<$tentative_link>

Diesem Anruf absagen
<$decline_link>',
    ),
...
anbei ein automatisch generierter Bericht, der für Sie geplant wurde.

Name des Berichts: $report_name

Ausführungsdatum und -uhrzeit des Berichts: $report_time',
    ),

    'comment_log_mention_email' => [
        'name' => 'E-Mail-Benachrichtigung über Systemkommentarprotokolle',
        'subject' => 'SugarCRM - $initiator_full_name hat Sie in einem(n) $singular_module_name erwähnt',
        'description' => 'Diese Vorlage wird verwendet, um E-Mail-Benachrichtigungen für Benutzer zu senden, die im Bereich „Kommentarprotokolle" markiert wurden.',
        'body' =>
            '<div>
                <p>Sie wurden im Kommentarprotokoll des folgenden Datensatzes erwähnt:  <a href="$record_url">$record_name</a></p>
                <p>Bitte melden Sie sich bei Sugar an, um den Kommentar anzuzeigen.</p>
            </div>',
        'txt_body' =>
'Sie wurden im Kommentarprotokoll des folgenden Datensatzes erwähnt: $record_name
...
'portal_forgot_password_email_link' => [
    'name' => 'E-Mail zum Zurücksetzen des Passworts für das Portal',
    'subject' => 'Setzen Sie das Passwort für Ihren Zugang zurück',
    'description' => 'Diese Vorlage wird verwendet, um einem Benutzer einen Link zum Zurücksetzen des Passworts des Benutzers für den Portalzugang zu senden.',
    'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Sie haben vor kurzem um das Zurücksetzen des Passworts für Ihren Zugang gebeten. </p><p>Klicken Sie auf den folgenden Link, um Ihr Passwort zurückzusetzen:</p><p> <a href="$portal_user_link_guid">$portal_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
    'txt_body' =>
'
    Sie haben vor kurzem um das Zurücksetzen des Passworts für Ihren Zugang gebeten.
    ...
    'portal_password_reset_confirmation_email' => [
        'name' => 'Bestätigungs-E-Mail über das Zurücksetzen des Passworts für das Portal',
        'subject' => 'Das Passwort für Ihren Zugang wurde zurückgesetzt',
        'description' => 'Diese Vorlage wird verwendet, um einem Benutzer des Portals zu bestätigen, dass das Passwort für seinen Zugang zurückgesetzt wurde.',
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Mit dieser E-Mail wird bestätigt, dass das Passwort für Ihren Portalzugang zurückgesetzt wurde. </p><p> Verwenden Sie den folgenden Link, um sich beim Portal anzumelden:</p><p> <a href="$portal_login_url">$portal_login_url</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
    Mit dieser E-Mail wird bestätigt, dass das Passwort für Ihren Portalzugang zurückgesetzt wurde.

    Verwenden Sie den folgenden Link, um sich beim Portal anzumelden:
