...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Não foi encontrado o suporte para banco de dados. Certifique-se de que você tem os drivers necessários para um dos seguintes tipos de banco de dados: MySQL, MS SQLServer, Oracle ou DB2. Você talvez precise remover o comentário da extensão no arquivo php.ini ou recompilá-lo com o arquivo binário correto, dependendo da sua versão do PHP. Consulte o seu manual do PHP para mais informações sobre como ativar o suporte para banco de dados.',
