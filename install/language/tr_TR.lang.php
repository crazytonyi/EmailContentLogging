...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri Tabanı Desteği bulunamadı.  Şu desteklenen Veri Tabanı Türlerinden biri için gerekli sürücülere sahip olduğunuzdan emin olun: MySQL, MS SQLServer, Oracle, veya DB2.  PHP\'nin sürümüne bağlı olarak php.ini dosyasındaki uzantı açıklamasını kaldırmanız veya doğru ikili dosya ile yeniden derlemeniz gerekebilir.  Veri Tabanı Desteğinin nasıl etkinleştirileceği konusunda daha fazla bilgi için lütfen PHP Kılavuzuna bakın.',
