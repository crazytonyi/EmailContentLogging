...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Não foi encontrado o Suporte para Base de dados. Certifique-se de que tem os drivers necessários para um dos seguintes tipos de base de dados: MySQL, MS SQLServer, Oracle ou DB2. Talvez seja necessário remover o comentário da extensão no ficheiro php.ini ou recompilá-lo com o ficheiro binário correcto, dependendo da sua versão do PHP. Consulte o seu manual do PHP para mais informações sobre como activar o Suporte para a Base de dados.',
