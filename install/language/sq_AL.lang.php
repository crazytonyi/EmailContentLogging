...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Mbështetja e bazës së të dhënave nuk u gjet. Sigurohuni që keni drejtuesit e nevojshëm për një nga llojet e mbështetura të bazës së të dhënave më poshtë: MySQL, MS SQLServer, Oracle ose DB2. Mund t\'ju duhet të hiqni prapashtesën në skedarin php.ini ose të krijoni sërish skedarin e duhur binar në varësi të versionit të PHP. Për më shumë informacione rreth mënyrës së aktivizimit të mbështetjes së bazës së të dhënave, referojuni manualit PHP.',
