...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Adatbázistámogatás nem található. Kérjük, győződjön meg róla, hogy rendelkezik a szükséges illesztőprogramokkal az alábbi támogatott adatbázistípusok egyikéhez: MySQL, MS SQLServer, Oracle vagy DB2. Előfordulhat, hogy törölnie kell a kiterjesztést a php.ini fájlban vagy a PHP-verziójától függően újra össze kell állítania a megfelelő bináris fájlt. Kérjük, tekintse meg a PHP-kézikönyvet, ha többet szeretne megtudni arról, hogy hogyan tudja engedélyezni az Adatbázistámogatást.',
