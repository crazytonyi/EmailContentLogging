...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nenašlo sa: Plánovač Sugar sa spustí s obmedzenou funkčnosťou. Služba Archivovanie e-mailov sa nespustí.',
...
<br><br>Bežne nesprávna konfigurácia nastane, keď direktíva <b>session.save_path</b> nesmeruje k platnému adresáru.<br><br>Opravte<a target=_new href='http://us2.php.net/manual/en/ref.session.php'> PHP konfiguráciu</a> v súbore php.ini umiestnenom tu nižšie.",
    ...
    'meeting_notification_email' => array(
        'name' => 'E-maily s upozornením o schôdzke',
        'subject' => 'Schôdzka SugarCRM – $event_name ',
        'description' => 'Táto šablóna sa používa, keď systém posiela používateľovi upozornenia o schôdzke.',
        'body' => '<div>
	<p>Komu: $assigned_user</p>

	<p>$assigned_by_user vás pozýva na schôdzku</p>

	<p>Predmet: $event_name<br/>
	Dátum začatia: $start_date<br/>
	Dátum ukončenia: $end_date</p>

	<p>Popis: $description</p>

	<p>Prijať túto schôdzku:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>Predbežne prijať túto schôdzku:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>Odmietnuť túto schôdzku:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'Komu: $assigned_user

$assigned_by_user vás pozýva na schôdzku

Predmet: $event_name
Dátum začatia: $start_date
Dátum ukončenia: $end_date

Popis: $description

Prijať túto schôdzku:
<$accept_link>

Predbežne prijať túto schôdzku
<$tentative_link>

Odmietnuť túto schôdzku
<$decline_link>',
    ),

    'call_notification_email' => array(
        'name' => 'E-maily s upozornením o volaní',
        'subject' => 'Volanie SugarCRM – $event_name ',
        'description' => 'Táto šablóna sa používa, keď systém posiela používateľovi upozornenia o volaní.',
        'body' => '<div>
	<p>Komu: $assigned_user</p>

	<p>$assigned_by_user vás pozýva na volanie</p>

	<p>Predmet: $event_name<br/>
	Dátum začatia: $start_date<br/>
	Trvanie: $hoursh, $minutesm</p>

	<p>Popis: $description</p>

	<p>Prijať toto volanie:<br/>
	<<a href="$accept_link">$accept_link</a>></p>
	<p>Predbežne prijať toto volanie:<br/>
	<<a href="$tentative_link">$tentative_link</a>></p>
	<p>Odmietnuť toto volanie:<br/>
	<<a href="$decline_link">$decline_link</a>></p>
</div>',
        'txt_body' =>
            'Komu: $assigned_user

$assigned_by_user vás pozýva na volanie

Predmet: $event_name
Dátum začatia: $start_date
Trvanie: $hoursh, $minutesm
...
Predbežne prijať toto volanie
<$tentative_link>

Odmietnuť toto volanie
<$decline_link>',
    ),
...
pripojené je automaticky generované hlásenie, ktoré bolo naplánované pre vás.

Názov hlásenia: $report_name

Dátum a čas spustenia hlásenia: $report_time',
    ),

    'comment_log_mention_email' => [
        'name' => 'E-mailové upozornenie systémového denníka komentárov',
        'subject' => 'SugarCRM – $initiator_full_name vás uviedol(-la) v $singular_module_name',
        'description' => 'Táto šablóna sa používa na odosielanie e-mailového upozornenia používateľom, ktorí boli označení v sekcii denníka komentárov.',
        'body' =>
            '<div>
                <p>Boli ste uvedený v denníku komentárov nasledujúceho záznamu:  <a href="$record_url">$record_name</a></p>
                <p>Prihláste sa do aplikácie Sugar, aby ste mohli zobraziť príslušný komentár.</p>
            </div>',
        'txt_body' =>
'Boli ste uvedený v denníku komentárov nasledujúceho záznamu: $record_name
...
'portal_forgot_password_email_link' => [
    'name' => 'E-mail v prípade zabudnutého portálového hesla',
    'subject' => 'Obnovte svoje heslo k účtu',
    'description' => 'Táto šablóna sa používa na odosielanie prepojenia používateľovi, na ktoré musí kliknúť, aby obnovil heslo k účtu používateľa portálu.',
    'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Nedávno ste požiadali o obnovenie svojho hesla k účtu. </p><p>Kliknite na prepojenie nižšie a obnovte svoje heslo:</p><p> <a href="$portal_user_link_guid">$portal_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
    'txt_body' =>
'
    Nedávno ste požiadali o obnovenie svojho hesla k účtu.
    ...
    'portal_password_reset_confirmation_email' => [
        'name' => 'E-mail s potvrdením obnovenia portálového hesla',
        'subject' => 'Heslo k vášmu účtu bolo obnovené',
        'description' => 'Táto šablóna sa používa na odosielanie potvrdenia používateľovi portálu, že heslo k jeho účtu bolo obnovené.',
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Tento e-mail slúži na potvrdenie, že heslo k vášmu účtu na portále bolo obnovené. </p><p>Pomocou prepojenia nižšie sa prihláste na portál:</p><p> <a href="$portal_login_url">$portal_login_url</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
    Tento e-mail slúži na potvrdenie, že heslo k vášmu účtu na portále bolo obnovené.

    Pomocou prepojenia nižšie sa prihláste na portál:
