...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Nu s-a găsit serviciul de asistență al bazei de date. Asigură-te că ai instalat driver-ele necesare pentru unul dintre următoarele tipuri de baze de date compatibile: MySQL, MS SQLServer, Oracle sau DB2. Va trebui eventual să ștergi comentariul aferent extensiei din fișierul php.ini sau să îl recompilezi cu fișierul binar corect, în funcție de versiunea de PHP. Consultă Manualul PHP pentru mai multe informații cu privire la activarea serviciului de asistență al bazei de date.',
