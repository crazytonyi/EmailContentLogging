...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'לא נמצאה תמיכה עבור מסד הנתונים. ודא שברשותך מנהלי ההתקנים הנחוצים עבור אחד מהסוגים הבאים של מסדי נתונים נתמכים: MySQL‏, MS SQLServer‏, Oracle או DB2. ייתכן שיהיה עליך להגדיר למהדר להתעלם מהסיומת בקובץ ה-php.ini, או להדר מחדש עם הקובץ הבינארי הנכון, בהתאם לגרסת ה-PHP שלך. ניתן לעיין במדריך ה-PHP לקבלת מידע נוסף על אופן ההפעלה של תמיכה עבור מסדי נתונים.',
