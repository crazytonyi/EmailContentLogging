...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'データベースサポートが見つかりませんでした。サポートされている次のデータベースタイプのいずれかに必要なドライバがあることを確認してください：MySQL、MS SQLServer、Oracle、またはDB2。PHPのバージョンによっては、php.iniファイルの拡張子のコメントを解除するか、適切なバイナリファイルで再コンパイルする必要がある場合があります。 データベースサポートを有効にする方法の詳細については、PHPマニュアルを参照してください。',
