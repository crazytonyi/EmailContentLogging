...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Il supporto del database non è stato trovato. Assicurarsi di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SQLServer, Oracle o DB2. Potrebbe essere necessario rimuovere il commento dall\'estensione nel file php.ini o ricompilare con il file binario corretto, a seconda della versione di PHP. Fare riferimento al manuale PHP per ulteriori informazioni su come abilitare il supporto database.',
