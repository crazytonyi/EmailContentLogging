...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Database-ondersteuning niet gevonden. Zorg ervoor dat u de nodige stuurprogramma\'s hebt voor een van de volgende ondersteunde soorten databases: MySQL, MS SQLServer, Oracle of DB2. Mogelijk moet u de extensie in het php.ini bestand verwijderen of opnieuw samenstellen met het juiste binaire bestand, afhankelijk van uw versie van PHP. Raadpleeg uw PHP-handleiding voor meer informatie over het inschakelen van database-ondersteuning.',
