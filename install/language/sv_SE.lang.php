...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasstöd hittades inte. Vänligen se till att du har de nödvändiga drivrutinerna för en av följande databastyper som stöds: MySQL, MS SQLServer, Oracle eller DB2.  Du kan behöva avkommentera tillägget i filen php.ini, eller omkompilera med rätt binära fil, beroende på din version av PHP.  Se PHP-manual för att få mer information om hur man aktiverar Databasstöd.',
