...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> '未找到：Sugar Scheduler 將運行，但功能受限。“電子郵件歸檔”服務將不會運行。',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '找不到數據庫支持。請確保您有以下受支持的數據庫類型之一所需的驅動程式：MySQL、MS SQLServer、Oracle 或 DB2。 您可能需要在 php.ini 文件中取消註釋副檔名，或者使用正確的二進制文件重新編譯，具體取決於您的 PHP 版本。 請參閱您的 PHP 手冊以獲取有關如何啟用數據庫支持的更多訊息。',
...
'portal_forgot_password_email_link' => [
    'name' => '門戶忘記密碼電子郵件',
    'subject' => '重設您的帳戶密碼',
    'description' => '這個模板用於給用戶提供一個連結，點擊即可重設門戶用戶的帳號密碼。',
    'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>您以請求重設帳戶密碼。</p><p>點擊以下連結重設您的密碼：</p><p> <a href="$portal_user_link_guid">$portal_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
    'txt_body' =>
'
    您以請求重設帳戶密碼。
    ...
    'portal_password_reset_confirmation_email' => [
        'name' => '門戶密碼重設確認電子郵件',
        'subject' => '您的帳戶密碼已重設',
        'description' => '此模塊用於向門戶用戶發送確認，告知其帳戶密碼已重設。',
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>此電子郵件用於您的門戶帳戶密碼已重設</p><p>請用以下連結登入門戶：</p><p> <a href="$portal_login_url">$portal_login_url</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
    此電子郵件用於確認您的門戶帳戶密碼已重設。
