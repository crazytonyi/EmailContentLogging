...
class UserMappingServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['OIDCUserMapping'] = $app->protect(function () use ($app) {
            $mapping = (isset($app['config']['oidc']['user_mapping'])) ? $app['config']['oidc']['user_mapping'] : [];
            return new OIDCUserMapping($mapping);
        });
    }
}
