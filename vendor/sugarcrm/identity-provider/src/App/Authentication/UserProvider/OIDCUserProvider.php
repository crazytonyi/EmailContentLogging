...
use Sugarcrm\IdentityProvider\Authentication\UserProvider\OIDCUserProvider as BaseOIDCUserProvider;
use Sugarcrm\IdentityProvider\Srn\Converter;
use Symfony\Component\Security\Core\Exception\UnsupportedUserException;
use Symfony\Component\Security\Core\User\UserInterface;

class OIDCUserProvider extends BaseOIDCUserProvider
{
    const PROVIDER = Providers::OIDC;
