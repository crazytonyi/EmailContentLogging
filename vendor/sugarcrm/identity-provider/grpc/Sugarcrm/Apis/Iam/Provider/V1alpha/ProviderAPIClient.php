...
class ProviderAPIClient extends \Grpc\BaseStub {
     ...
     * @param \Sugarcrm\Apis\Iam\Provider\V1alpha\ConfigureOidcProviderRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ConfigureOidcProvider(\Sugarcrm\Apis\Iam\Provider\V1alpha\ConfigureOidcProviderRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/sugarcrm.apis.iam.provider.v1alpha.ProviderAPI/ConfigureOidcProvider',
        $argument,
        ['\Sugarcrm\Apis\Iam\Provider\V1alpha\OidcProvider', 'decode'],
        $metadata, $options);
    }

    /**
     * @param \Sugarcrm\Apis\Iam\Provider\V1alpha\GetOidcProviderRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetOidcProvider(\Sugarcrm\Apis\Iam\Provider\V1alpha\GetOidcProviderRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/sugarcrm.apis.iam.provider.v1alpha.ProviderAPI/GetOidcProvider',
        $argument,
        ['\Sugarcrm\Apis\Iam\Provider\V1alpha\OidcProvider', 'decode'],
        $metadata, $options);
    }
    ...
    /**
     * @param \Sugarcrm\Apis\Iam\Provider\V1alpha\DeleteOidcProviderRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function DeleteOidcProvider(\Sugarcrm\Apis\Iam\Provider\V1alpha\DeleteOidcProviderRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/sugarcrm.apis.iam.provider.v1alpha.ProviderAPI/DeleteOidcProvider',
        $argument,
        ['\Google\Protobuf\GPBEmpty', 'decode'],
        $metadata, $options);
    }
