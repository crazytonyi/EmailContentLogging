...
class UserAPIClient extends \Grpc\BaseStub {
    ...
    /**
     * Retrieve a User
     * if endpoint called with a scope "https://apis.sugarcrm.com/auth/iam.password.read" then  the response will contain user’s password hash
     ...
     * scope required https://apis.sugarcrm.com/auth/iam.password.write
