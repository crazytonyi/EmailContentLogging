 ...
 *                     +----------------------+------------+------------+
 *                                            |            |            |
 *                                         blobstore    crm prod    crm sandbox
 *                                            |
 *                                     +------+------+
 *                                     |             |
 *                                  bucket a      bucket b
...
class Kind extends \Google\Protobuf\Internal\Message
{
     ...
     * readable name like: iam-user, blobstore-bucket, ... Allowed characters
     ...
     * Note that the variables names should be chosen wisely. Once a kind has
     ...
     * global variables are used. Therefore, it is advised to use unambiguous
     * variable names.
     * Following examples are being executed inside an application which is
     * deployed in the `us-west-2` region and partition `cloud`. They have
